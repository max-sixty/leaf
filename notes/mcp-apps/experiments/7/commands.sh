...
results="$repo/notes/mcp-apps/experiments/7/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-7.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/7/observe.py "$run_dir/page" \
  >"$results/reference-host.json"

# Open the generated compact-app screenshot:
# open notes/mcp-apps/experiments/7/results/compact-ask-420x360.png
