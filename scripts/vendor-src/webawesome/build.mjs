...
const hosts =
  "wa-checkbox, wa-color-picker, wa-copy-button, wa-comparison, wa-switch, wa-radio-group, wa-radio, wa-slider, wa-select, wa-option, wa-input, wa-textarea, wa-number-input";
