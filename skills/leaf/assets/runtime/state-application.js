...
import { replaceClaimState } from "./updates.js";
import {
  isSignoffDeclared,
  paintApproval,
  renderStatus,
...
import { reconcileState } from "./projection.js";
import { updateFab } from "./composing/surface.js";
...
export async function receiveState(state) {
