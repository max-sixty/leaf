...
export function bake() {
  ...
  // Runtime controls can live in the document or a widget's shadow tree. Strip
  // both before serialization; retain conversation messages and native disclosures.
  ...
  all(
    "script, .lf-chrome, .lf-receipt, .lf-say, .lf-mark-note, " +
      '.lf-margin-action[data-lf-role="reading"]',
