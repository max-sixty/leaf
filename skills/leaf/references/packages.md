...
rules to its descendants; a query container cannot query itself. Keep the host's own
layout intrinsic, or put the properties that change on a descendant layout box.
