...
// inline text diff. An item answering nothing promises nothing, which is what
// leaves a Change margin element over a block the comparison cannot align for the plain
// travel it always was.
...
function collectEntries() {
  ...
  comparisonChanges().forEach((target, index) => {
    ...
    add(groups, target, {
      ...
      // travelling to the other version and back. Where it kept none, the press is the travel it always was,
