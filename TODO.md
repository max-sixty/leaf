...
| eslint `no-cycle` or dependency-cruiser for the import graph and Tarjan SCC in `eslint.config.mjs`. | S | ~180 | High | The ownership rules in the eslint config stay hand-written |
