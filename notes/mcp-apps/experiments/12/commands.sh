...
results="$repo/notes/mcp-apps/experiments/12/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-12.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/12/observe.py "$run_dir/page" \
