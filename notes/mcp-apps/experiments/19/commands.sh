...
results="$repo/notes/mcp-apps/experiments/19/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-19.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/19/observe.py "$run_dir/page" \
