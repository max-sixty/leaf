...
results="$repo/notes/mcp-apps/experiments/15/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-15.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/15/observe.py "$run_dir/page" \
