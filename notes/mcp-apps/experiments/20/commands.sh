...
results="$repo/notes/mcp-apps/experiments/20/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-20.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/20/observe.py "$run_dir/page" \
