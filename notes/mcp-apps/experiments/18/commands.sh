...
results="$repo/notes/mcp-apps/experiments/18/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-18.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/18/observe.py "$run_dir/page" \
