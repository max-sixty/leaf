...
results="$repo/notes/mcp-apps/experiments/11/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-11.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/11/observe.py "$run_dir/page" \
