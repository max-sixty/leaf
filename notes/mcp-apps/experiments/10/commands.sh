...
results="$repo/notes/mcp-apps/experiments/10/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-10.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/10/observe.py "$run_dir/page" \
