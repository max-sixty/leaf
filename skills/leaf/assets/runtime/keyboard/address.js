...
// `offer` and `selectableOffer` write the value the theme's hand already reads — so a
// widget family that joins tomorrow is addressable with its module and no entry here.
// The register stays about capabilities; a press is a route to one, and this is how a
// route that spends no key of its own is reached.
