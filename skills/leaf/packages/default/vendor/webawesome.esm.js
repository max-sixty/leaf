...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function et(t,e){function i(a){let n=t.getBoundingClientRect(),l=t.ownerDocument.defaultView,h=n.left+l.pageXOffset,u=n.top+l.pageYOffset,p=a.pageX-h,V=a.pageY-u;e?.onMove&&e.onMove(p,V)}function r(){document.removeEventListener("pointermove",i),document.removeEventListener("pointerup",r),e?.onStop&&e.onStop()}document.addEventListener("pointermove",i,{passive:!0}),document.addEventListener("pointerup",r),e?.initialEvent instanceof PointerEvent&&i(e.initialEvent)}var Et=typeof window<"u"&&"ontouchstart"in window,ot=class{constructor(t,e){this.isActive=!1,this.isDragging=!1,this.handleDragStart=i=>{let r="touches"in i?i.touches[0].clientX:i.clientX,a="touches"in i?i.touches[0].clientY:i.clientY;this.isDragging||!Et&&i.buttons>1||(this.isDragging=!0,document.addEventListener("pointerup",this.handleDragStop),document.addEventListener("pointermove",this.handleDragMove),document.addEventListener("pointercancel",this.handleDragStop),document.addEventListener("touchend",this.handleDragStop),document.addEventListener("touchmove",this.handleDragMove),document.addEventListener("touchcancel",this.handleDragStop),this.options.start(r,a))},this.handleDragStop=i=>{let r="changedTouches"in i?i.changedTouches[0].clientX:i.clientX,a="changedTouches"in i?i.changedTouches[0].clientY:i.clientY;this.isDragging=!1,document.removeEventListener("pointerup",this.handleDragStop),document.removeEventListener("pointermove",this.handleDragMove),document.removeEventListener("pointercancel",this.handleDragStop),document.removeEventListener("touchend",this.handleDragStop),document.removeEventListener("touchmove",this.handleDragMove),document.removeEventListener("touchcancel",this.handleDragStop),this.options.stop(r,a)},this.handleDragMove=i=>{let r="touches"in i?i.touches[0].clientX:i.clientX,a="touches"in i?i.touches[0].clientY:i.clientY;window.getSelection()?.removeAllRanges(),this.options.move(r,a)},this.element=t,this.options={start:()=>{},stop:()=>{},move:()=>{},...e},this.start()}start(){this.isActive||(this.element.addEventListener("pointerdown",this.handleDragStart),Et&&this.element.addEventListener("touchstart",this.handleDragStart),this.isActive=!0)}stop(){document.removeEventListener("pointerup",this.handleDragStop),document.removeEventListener("pointermove",this.handleDragMove),document.removeEventListener("pointercancel",this.handleDragStop),document.removeEventListener("touchend",this.handleDragStop),document.removeEventListener("touchmove",this.handleDragMove),document.removeEventListener("touchcancel",this.handleDragStop),this.element.removeEventListener("pointerdown",this.handleDragStart),Et&&this.element.removeEventListener("touchstart",this.handleDragStart),this.isActive=!1,this.isDragging=!1}toggle(t){(t!==void 0?t:!this.isActive)?this.start():this.stop()}};function _(t,e){ge(t)&&(t="100%");let i=we(t);return t=e===360?t:Math.min(e,Math.max(0,parseFloat(t))),i&&(t=parseInt(String(t*e),10)/100),Math.abs(t-e)<1e-6?1:(e===360?t=(t<0?t%e+e:t%e)/parseFloat(String(e)):t=t%e/parseFloat(String(e)),t)}function at(t){return Math.min(1,Math.max(0,t))}function ge(t){return typeof t=="string"&&t.indexOf(".")!==-1&&parseFloat(t)===1}function we(t){return typeof t=="string"&&t.indexOf("%")!==-1}function xt(t){return t=parseFloat(t),(isNaN(t)||t<0||t>1)&&(t=1),t}function st(t){return Number(t)<=1?`${Number(t)*100}%`:t}function G(t){return t.length===1?"0"+t:String(t)}function Xt(t,e,i){return{r:_(t,255)*255,g:_(e,255)*255,b:_(i,255)*255}}function zt(t,e,i){t=_(t,255),e=_(e,255),i=_(i,255);let r=Math.max(t,e,i),a=Math.min(t,e,i),n=0,l=0,h=(r+a)/2;if(r===a)l=0,n=0;else{let u=r-a;switch(l=h>.5?u/(2-r-a):u/(r+a),r){case t:n=(e-i)/u+(e<i?6:0);break;case e:n=(i-t)/u+2;break;case i:n=(t-e)/u+4;break;default:break}n/=6}return{h:n,s:l,l:h}}function Vt(t,e,i){return i<0&&(i+=1),i>1&&(i-=1),i<1/6?t+(e-t)*(6*i):i<1/2?e:i<2/3?t+(e-t)*(2/3-i)*6:t}function Yt(t,e,i){let r,a,n;if(t=_(t,360),e=_(e,100),i=_(i,100),e===0)a=i,n=i,r=i;else{let l=i<.5?i*(1+e):i+e-i*e,h=2*i-l;r=Vt(h,l,t+1/3),a=Vt(h,l,t),n=Vt(h,l,t-1/3)}return{r:r*255,g:a*255,b:n*255}}function Dt(t,e,i){t=_(t,255),e=_(e,255),i=_(i,255);let r=Math.max(t,e,i),a=Math.min(t,e,i),n=0,l=r,h=r-a,u=r===0?0:h/r;if(r===a)n=0;else{switch(r){case t:n=(e-i)/h+(e<i?6:0);break;case e:n=(i-t)/h+2;break;case i:n=(t-e)/h+4;break;default:break}n/=6}return{h:n,s:u,v:l}}function Zt(t,e,i){t=_(t,360)*6,e=_(e,100),i=_(i,100);let r=Math.floor(t),a=t-r,n=i*(1-e),l=i*(1-a*e),h=i*(1-(1-a)*e),u=r%6,p=[i,l,n,n,h,i][u],V=[h,i,i,l,n,n][u],M=[n,n,h,i,i,l][u];return{r:p*255,g:V*255,b:M*255}}function _t(t,e,i,r){let a=[G(Math.round(t).toString(16)),G(Math.round(e).toString(16)),G(Math.round(i).toString(16))];return r&&a[0].startsWith(a[0].charAt(1))&&a[1].startsWith(a[1].charAt(1))&&a[2].startsWith(a[2].charAt(1))?a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0):a.join("")}function Jt(t,e,i,r,a){let n=[G(Math.round(t).toString(16)),G(Math.round(e).toString(16)),G(Math.round(i).toString(16)),G(ye(r))];return a&&n[0].startsWith(n[0].charAt(1))&&n[1].startsWith(n[1].charAt(1))&&n[2].startsWith(n[2].charAt(1))&&n[3].startsWith(n[3].charAt(1))?n[0].charAt(0)+n[1].charAt(0)+n[2].charAt(0)+n[3].charAt(0):n.join("")}function Qt(t,e,i,r){let a=t/100,n=e/100,l=i/100,h=r/100,u=255*(1-a)*(1-h),p=255*(1-n)*(1-h),V=255*(1-l)*(1-h);return{r:u,g:p,b:V}}function Tt(t,e,i){let r=1-t/255,a=1-e/255,n=1-i/255,l=Math.min(r,a,n);return l===1?(r=0,a=0,n=0):(r=(r-l)/(1-l)*100,a=(a-l)/(1-l)*100,n=(n-l)/(1-l)*100),l*=100,{c:Math.round(r),m:Math.round(a),y:Math.round(n),k:Math.round(l)}}function ye(t){return Math.round(parseFloat(t)*255).toString(16)}function At(t){return q(t)/255}function q(t){return parseInt(t,16)}function te(t){return{r:t>>16,g:(t&65280)>>8,b:t&255}}var nt={aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#00ffff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000000",blanchedalmond:"#ffebcd",blue:"#0000ff",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkgray:"#a9a9a9",darkgreen:"#006400",darkgrey:"#a9a9a9",darkkhaki:"#bdb76b",darkmagenta:"#8b008b",darkolivegreen:"#556b2f",darkorange:"#ff8c00",darkorchid:"#9932cc",darkred:"#8b0000",darksalmon:"#e9967a",darkseagreen:"#8fbc8f",darkslateblue:"#483d8b",darkslategray:"#2f4f4f",darkslategrey:"#2f4f4f",darkturquoise:"#00ced1",darkviolet:"#9400d3",deeppink:"#ff1493",deepskyblue:"#00bfff",dimgray:"#696969",dimgrey:"#696969",dodgerblue:"#1e90ff",firebrick:"#b22222",floralwhite:"#fffaf0",forestgreen:"#228b22",fuchsia:"#ff00ff",gainsboro:"#dcdcdc",ghostwhite:"#f8f8ff",goldenrod:"#daa520",gold:"#ffd700",gray:"#808080",green:"#008000",greenyellow:"#adff2f",grey:"#808080",honeydew:"#f0fff0",hotpink:"#ff69b4",indianred:"#cd5c5c",indigo:"#4b0082",ivory:"#fffff0",khaki:"#f0e68c",lavenderblush:"#fff0f5",lavender:"#e6e6fa",lawngreen:"#7cfc00",lemonchiffon:"#fffacd",lightblue:"#add8e6",lightcoral:"#f08080",lightcyan:"#e0ffff",lightgoldenrodyellow:"#fafad2",lightgray:"#d3d3d3",lightgreen:"#90ee90",lightgrey:"#d3d3d3",lightpink:"#ffb6c1",lightsalmon:"#ffa07a",lightseagreen:"#20b2aa",lightskyblue:"#87cefa",lightslategray:"#778899",lightslategrey:"#778899",lightsteelblue:"#b0c4de",lightyellow:"#ffffe0",lime:"#00ff00",limegreen:"#32cd32",linen:"#faf0e6",magenta:"#ff00ff",maroon:"#800000",mediumaquamarine:"#66cdaa",mediumblue:"#0000cd",mediumorchid:"#ba55d3",mediumpurple:"#9370db",mediumseagreen:"#3cb371",mediumslateblue:"#7b68ee",mediumspringgreen:"#00fa9a",mediumturquoise:"#48d1cc",mediumvioletred:"#c71585",midnightblue:"#191970",mintcream:"#f5fffa",mistyrose:"#ffe4e1",moccasin:"#ffe4b5",navajowhite:"#ffdead",navy:"#000080",oldlace:"#fdf5e6",olive:"#808000",olivedrab:"#6b8e23",orange:"#ffa500",orangered:"#ff4500",orchid:"#da70d6",palegoldenrod:"#eee8aa",palegreen:"#98fb98",paleturquoise:"#afeeee",palevioletred:"#db7093",papayawhip:"#ffefd5",peachpuff:"#ffdab9",peru:"#cd853f",pink:"#ffc0cb",plum:"#dda0dd",powderblue:"#b0e0e6",purple:"#800080",rebeccapurple:"#663399",red:"#ff0000",rosybrown:"#bc8f8f",royalblue:"#4169e1",saddlebrown:"#8b4513",salmon:"#fa8072",sandybrown:"#f4a460",seagreen:"#2e8b57",seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"};function ee(t){let e={r:0,g:0,b:0},i=1,r=null,a=null,n=null,l=!1,h=!1;return typeof t=="string"&&(t=$e(t)),typeof t=="object"&&(F(t.r)&&F(t.g)&&F(t.b)?(e=Xt(t.r,t.g,t.b),l=!0,h=String(t.r).substr(-1)==="%"?"prgb":"rgb"):F(t.h)&&F(t.s)&&F(t.v)?(r=st(t.s),a=st(t.v),e=Zt(t.h,r,a),l=!0,h="hsv"):F(t.h)&&F(t.s)&&F(t.l)?(r=st(t.s),n=st(t.l),e=Yt(t.h,r,n),l=!0,h="hsl"):F(t.c)&&F(t.m)&&F(t.y)&&F(t.k)&&(e=Qt(t.c,t.m,t.y,t.k),l=!0,h="cmyk"),Object.prototype.hasOwnProperty.call(t,"a")&&(i=t.a)),i=xt(i),{ok:l,format:t.format||h,r:Math.min(255,Math.max(e.r,0)),g:Math.min(255,Math.max(e.g,0)),b:Math.min(255,Math.max(e.b,0)),a:i}}var xe="[-\\+]?\\d+%?",ke="[-\\+]?\\d*\\.\\d+%?",X="(?:"+ke+")|(?:"+xe+")",Mt="[\\s|\\(]+("+X+")[,|\\s]+("+X+")[,|\\s]+("+X+")\\s*\\)?",kt="[\\s|\\(]+("+X+")[,|\\s]+("+X+")[,|\\s]+("+X+")[,|\\s]+("+X+")\\s*\\)?",I={CSS_UNIT:new RegExp(X),rgb:new RegExp("rgb"+Mt),rgba:new RegExp("rgba"+kt),hsl:new RegExp("hsl"+Mt),hsla:new RegExp("hsla"+kt),hsv:new RegExp("hsv"+Mt),hsva:new RegExp("hsva"+kt),cmyk:new RegExp("cmyk"+kt),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};function $e(t){if(t=t.trim().toLowerCase(),t.length===0)return!1;let e=!1;if(nt[t])t=nt[t],e=!0;else if(t==="transparent")return{r:0,g:0,b:0,a:0,format:"name"};let i=I.rgb.exec(t);return i?{r:i[1],g:i[2],b:i[3]}:(i=I.rgba.exec(t),i?{r:i[1],g:i[2],b:i[3],a:i[4]}:(i=I.hsl.exec(t),i?{h:i[1],s:i[2],l:i[3]}:(i=I.hsla.exec(t),i?{h:i[1],s:i[2],l:i[3],a:i[4]}:(i=I.hsv.exec(t),i?{h:i[1],s:i[2],v:i[3]}:(i=I.hsva.exec(t),i?{h:i[1],s:i[2],v:i[3],a:i[4]}:(i=I.cmyk.exec(t),i?{c:i[1],m:i[2],y:i[3],k:i[4]}:(i=I.hex8.exec(t),i?{r:q(i[1]),g:q(i[2]),b:q(i[3]),a:At(i[4]),format:e?"name":"hex8"}:(i=I.hex6.exec(t),i?{r:q(i[1]),g:q(i[2]),b:q(i[3]),format:e?"name":"hex"}:(i=I.hex4.exec(t),i?{r:q(i[1]+i[1]),g:q(i[2]+i[2]),b:q(i[3]+i[3]),a:At(i[4]+i[4]),format:e?"name":"hex8"}:(i=I.hex3.exec(t),i?{r:q(i[1]+i[1]),g:q(i[2]+i[2]),b:q(i[3]+i[3]),format:e?"name":"hex"}:!1))))))))))}function F(t){return typeof t=="number"?!Number.isNaN(t):I.CSS_UNIT.test(t)}var lt=class t{constructor(e="",i={}){if(e instanceof t)return e;typeof e=="number"&&(e=te(e)),this.originalInput=e;let r=ee(e);this.originalInput=e,this.r=r.r,this.g=r.g,this.b=r.b,this.a=r.a,this.roundA=Math.round(100*this.a)/100,this.format=i.format??r.format,this.gradientType=i.gradientType,this.r<1&&(this.r=Math.round(this.r)),this.g<1&&(this.g=Math.round(this.g)),this.b<1&&(this.b=Math.round(this.b)),this.isValid=r.ok}isDark(){return this.getBrightness()<128}isLight(){return!this.isDark()}getBrightness(){let e=this.toRgb();return(e.r*299+e.g*587+e.b*114)/1e3}getLuminance(){let e=this.toRgb(),i,r,a,n=e.r/255,l=e.g/255,h=e.b/255;return n<=.03928?i=n/12.92:i=Math.pow((n+.055)/1.055,2.4),l<=.03928?r=l/12.92:r=Math.pow((l+.055)/1.055,2.4),h<=.03928?a=h/12.92:a=Math.pow((h+.055)/1.055,2.4),.2126*i+.7152*r+.0722*a}getAlpha(){return this.a}setAlpha(e){return this.a=xt(e),this.roundA=Math.round(100*this.a)/100,this}isMonochrome(){let{s:e}=this.toHsl();return e===0}toHsv(){let e=Dt(this.r,this.g,this.b);return{h:e.h*360,s:e.s,v:e.v,a:this.a}}toHsvString(){let e=Dt(this.r,this.g,this.b),i=Math.round(e.h*360),r=Math.round(e.s*100),a=Math.round(e.v*100);return this.a===1?`hsv(${i}, ${r}%, ${a}%)`:`hsva(${i}, ${r}%, ${a}%, ${this.roundA})`}toHsl(){let e=zt(this.r,this.g,this.b);return{h:e.h*360,s:e.s,l:e.l,a:this.a}}toHslString(){let e=zt(this.r,this.g,this.b),i=Math.round(e.h*360),r=Math.round(e.s*100),a=Math.round(e.l*100);return this.a===1?`hsl(${i}, ${r}%, ${a}%)`:`hsla(${i}, ${r}%, ${a}%, ${this.roundA})`}toHex(e=!1){return _t(this.r,this.g,this.b,e)}toHexString(e=!1){return"#"+this.toHex(e)}toHex8(e=!1){return Jt(this.r,this.g,this.b,this.a,e)}toHex8String(e=!1){return"#"+this.toHex8(e)}toHexShortString(e=!1){return this.a===1?this.toHexString(e):this.toHex8String(e)}toRgb(){return{r:Math.round(this.r),g:Math.round(this.g),b:Math.round(this.b),a:this.a}}toRgbString(){let e=Math.round(this.r),i=Math.round(this.g),r=Math.round(this.b);return this.a===1?`rgb(${e}, ${i}, ${r})`:`rgba(${e}, ${i}, ${r}, ${this.roundA})`}toPercentageRgb(){let e=i=>`${Math.round(_(i,255)*100)}%`;return{r:e(this.r),g:e(this.g),b:e(this.b),a:this.a}}toPercentageRgbString(){let e=i=>Math.round(_(i,255)*100);return this.a===1?`rgb(${e(this.r)}%, ${e(this.g)}%, ${e(this.b)}%)`:`rgba(${e(this.r)}%, ${e(this.g)}%, ${e(this.b)}%, ${this.roundA})`}toCmyk(){return{...Tt(this.r,this.g,this.b)}}toCmykString(){let{c:e,m:i,y:r,k:a}=Tt(this.r,this.g,this.b);return`cmyk(${e}, ${i}, ${r}, ${a})`}toName(){if(this.a===0)return"transparent";if(this.a<1)return!1;let e="#"+_t(this.r,this.g,this.b,!1);for(let[i,r]of Object.entries(nt))if(e===r)return i;return!1}toString(e){let i=!!e;e=e??this.format;let r=!1,a=this.a<1&&this.a>=0;return!i&&a&&(e.startsWith("hex")||e==="name")?e==="name"&&this.a===0?this.toName():this.toRgbString():(e==="rgb"&&(r=this.toRgbString()),e==="prgb"&&(r=this.toPercentageRgbString()),(e==="hex"||e==="hex6")&&(r=this.toHexString()),e==="hex3"&&(r=this.toHexString(!0)),e==="hex4"&&(r=this.toHex8String(!0)),e==="hex8"&&(r=this.toHex8String()),e==="name"&&(r=this.toName()),e==="hsl"&&(r=this.toHslString()),e==="hsv"&&(r=this.toHsvString()),e==="cmyk"&&(r=this.toCmykString()),r||this.toHexString())}toNumber(){return(Math.round(this.r)<<16)+(Math.round(this.g)<<8)+Math.round(this.b)}clone(){return new t(this.toString())}lighten(e=10){let i=this.toHsl();return i.l+=e/100,i.l=at(i.l),new t(i)}brighten(e=10){let i=this.toRgb();return i.r=Math.max(0,Math.min(255,i.r-Math.round(255*-(e/100)))),i.g=Math.max(0,Math.min(255,i.g-Math.round(255*-(e/100)))),i.b=Math.max(0,Math.min(255,i.b-Math.round(255*-(e/100)))),new t(i)}darken(e=10){let i=this.toHsl();return i.l-=e/100,i.l=at(i.l),new t(i)}tint(e=10){return this.mix("white",e)}shade(e=10){return this.mix("black",e)}desaturate(e=10){let i=this.toHsl();return i.s-=e/100,i.s=at(i.s),new t(i)}saturate(e=10){let i=this.toHsl();return i.s+=e/100,i.s=at(i.s),new t(i)}greyscale(){return this.desaturate(100)}spin(e){let i=this.toHsl(),r=(i.h+e)%360;return i.h=r<0?360+r:r,new t(i)}mix(e,i=50){let r=this.toRgb(),a=new t(e).toRgb(),n=i/100,l={r:(a.r-r.r)*n+r.r,g:(a.g-r.g)*n+r.g,b:(a.b-r.b)*n+r.b,a:(a.a-r.a)*n+r.a};return new t(l)}analogous(e=6,i=30){let r=this.toHsl(),a=360/i,n=[this];for(r.h=(r.h-(a*e>>1)+720)%360;--e;)r.h=(r.h+a)%360,n.push(new t(r));return n}complement(){let e=this.toHsl();return e.h=(e.h+180)%360,new t(e)}monochromatic(e=6){let i=this.toHsv(),{h:r}=i,{s:a}=i,{v:n}=i,l=[],h=1/e;for(;e--;)l.push(new t({h:r,s:a,v:n})),n=(n+h)%1;return l}splitcomplement(){let e=this.toHsl(),{h:i}=e;return[this,new t({h:(i+72)%360,s:e.s,l:e.l}),new t({h:(i+216)%360,s:e.s,l:e.l})]}onBackground(e){let i=this.toRgb(),r=new t(e).toRgb(),a=i.a+r.a*(1-i.a);return new t({r:(i.r*i.a+r.r*r.a*(1-i.a))/a,g:(i.g*i.a+r.g*r.a*(1-i.a))/a,b:(i.b*i.a+r.b*r.a*(1-i.a))/a,a})}triad(){return this.polyad(3)}tetrad(){return this.polyad(4)}polyad(e){let i=this.toHsl(),{h:r}=i,a=[this],n=360/e;for(let l=1;l<e;l++)a.push(new t({h:(r+l*n)%360,s:i.s,l:i.l}));return a}equals(e){let i=new t(e);return this.format==="cmyk"||i.format==="cmyk"?this.toCmykString()===i.toCmykString():this.toRgbString()===i.toRgbString()}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ie="important",Ce=" !"+ie,T=gt(class extends wt{constructor(t){if(super(t),t.type!==vt.ATTRIBUTE||t.name!=="style"||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let r=t[i];return r==null?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(t,[e]){let{style:i}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(let r of this.ft)e[r]==null&&(this.ft.delete(r),r.includes("-")?i.removeProperty(r):i[r]=null);for(let r in e){let a=e[r];if(a!=null){this.ft.add(r);let n=typeof a=="string"&&a.endsWith(Ce);r.includes("-")||n?i.setProperty(r,n?a.slice(0,-11):a,n?ie:""):i[r]=a}}return dt}});/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var c=class extends A{constructor(){super(),this.hasSlotController=new H(this,"hint","label"),this.isSafeValue=!1,this.localize=new z(this),this.hasFocus=!1,this.isDraggingGridHandle=!1,this.inputValue="",this.hue=0,this.isEmpty=!0,this.saturation=100,this.brightness=100,this.alpha=100,this._value=null,this.defaultValue=this.getAttribute("value")||null,this.withLabel=!1,this.withHint=!1,this.hasEyeDropper=!1,this.label="",this.hint="",this.format="hex",this.size="m",this.placement="bottom-start",this.withoutFormatToggle=!1,this.name=null,this.disabled=!1,this.open=!1,this.opacity=!1,this.uppercase=!1,this.swatches="",this.required=!1,this.handleFocusIn=()=>{this.hasFocus=!0},this.handleFocusOut=()=>{this.hasFocus=!1},this.reportValidityAfterShow=()=>{this.removeEventListener("invalid",this.emitInvalid),this.reportValidity(),this.addEventListener("invalid",this.emitInvalid)},this.handleKeyDown=e=>{this.open&&e.key==="Escape"&&rt(this)&&(e.stopPropagation(),this.hide(),this.focus())},this.handleDocumentKeyDown=e=>{if(e.key==="Escape"&&this.open&&rt(this)){e.stopPropagation(),this.focus(),this.hide();return}e.key==="Tab"&&setTimeout(()=>{let i=this.getRootNode()instanceof ShadowRoot?document.activeElement?.shadowRoot?.activeElement:document.activeElement;(!this||i?.closest(this.tagName.toLowerCase())!==this)&&this.hide()})},this.handleDocumentMouseDown=e=>{let r=e.composedPath().some(a=>a instanceof Element&&(a.closest(".color-picker")||a===this.trigger));this&&!r&&this.hide()},this.addEventListener("focusin",this.handleFocusIn),this.addEventListener("focusout",this.handleFocusOut),this.opacity=this.hasAttribute("opacity"),this.uppercase=this.hasAttribute("uppercase");let t=this.getAttribute("format");(t==="rgb"||t==="hsl"||t==="hsv")&&(this.format=t),this.handleValueChange("",this.value||"")}static get validators(){let t=[ft()];return[...super.validators,...t]}get validationTarget(){return this.popup?.active?this.input:this.trigger}get value(){return this.valueHasChanged?this._value:this._value??this.defaultValue}set value(t){this._value!==t&&(this.valueHasChanged=!0,this._value=t)}handleSizeChange(){L(this.localName,this.size)}updateFormValue(t){if(t==null){this.setValue("",null);return}super.updateFormValue(t)}handleCopy(){this.input.select(),document.execCommand("copy"),this.previewButton.focus(),this.previewButton.classList.add("preview-color-copied"),this.previewButton.addEventListener("animationend",()=>{this.previewButton.classList.remove("preview-color-copied")})}handleFormatToggle(){let t=["hex","rgb","hsl","hsv"],e=(t.indexOf(this.format)+1)%t.length;this.format=t[e],this.setColor(this.value||""),this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))})}handleAlphaDrag(t){let e=this.shadowRoot.querySelector(".slider.alpha"),i=e.querySelector(".slider-handle"),{width:r}=e.getBoundingClientRect(),a=this.value,n=this.value;i.focus(),t.preventDefault(),et(e,{onMove:l=>{this.alpha=$(l/r*100,0,100),this.syncValues(),this.value!==n&&(n=this.value,this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))}))},onStop:()=>{this.value!==a&&(a=this.value,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))},initialEvent:t})}handleHueDrag(t){let e=this.shadowRoot.querySelector(".slider.hue"),i=e.querySelector(".slider-handle"),{width:r}=e.getBoundingClientRect(),a=this.value,n=this.value;i.focus(),t.preventDefault(),et(e,{onMove:l=>{this.hue=$(l/r*360,0,360),this.syncValues(),this.value!==n&&(n=this.value,this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input"))}))},onStop:()=>{this.value!==a&&(a=this.value,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))},initialEvent:t})}handleGridDrag(t){let e=this.shadowRoot.querySelector(".grid"),i=e.querySelector(".grid-handle"),{width:r,height:a}=e.getBoundingClientRect(),n=this.value,l=this.value;i.focus(),t.preventDefault(),this.isDraggingGridHandle=!0,et(e,{onMove:(h,u)=>{this.saturation=$(h/r*100,0,100),this.brightness=$(100-u/a*100,0,100),this.syncValues(),this.value!==l&&(l=this.value,this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))}))},onStop:()=>{this.isDraggingGridHandle=!1,this.value!==n&&(n=this.value,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))},initialEvent:t})}handleAlphaKeyDown(t){let e=t.shiftKey?10:1,i=this.value;t.key==="ArrowLeft"&&(t.preventDefault(),this.alpha=$(this.alpha-e,0,100),this.syncValues()),t.key==="ArrowRight"&&(t.preventDefault(),this.alpha=$(this.alpha+e,0,100),this.syncValues()),t.key==="Home"&&(t.preventDefault(),this.alpha=0,this.syncValues()),t.key==="End"&&(t.preventDefault(),this.alpha=100,this.syncValues()),this.value!==i&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}handleHueKeyDown(t){let e=t.shiftKey?10:1,i=this.value;t.key==="ArrowLeft"&&(t.preventDefault(),this.hue=$(this.hue-e,0,360),this.syncValues()),t.key==="ArrowRight"&&(t.preventDefault(),this.hue=$(this.hue+e,0,360),this.syncValues()),t.key==="Home"&&(t.preventDefault(),this.hue=0,this.syncValues()),t.key==="End"&&(t.preventDefault(),this.hue=360,this.syncValues()),this.value!==i&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}handleGridKeyDown(t){let e=t.shiftKey?10:1,i=this.value;t.key==="ArrowLeft"&&(t.preventDefault(),this.saturation=$(this.saturation-e,0,100),this.syncValues()),t.key==="ArrowRight"&&(t.preventDefault(),this.saturation=$(this.saturation+e,0,100),this.syncValues()),t.key==="ArrowUp"&&(t.preventDefault(),this.brightness=$(this.brightness+e,0,100),this.syncValues()),t.key==="ArrowDown"&&(t.preventDefault(),this.brightness=$(this.brightness-e,0,100),this.syncValues()),this.value!==i&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}handleInputChange(t){let e=t.target,i=this.value;t.stopPropagation(),this.input.value?(this.setColor(e.value),e.value=this.value||""):this.value="",this.value!==i&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}handleInputInput(t){this.updateValidity(),t.stopPropagation()}handleInputKeyDown(t){if(t.key==="Enter"){let e=this.value;this.input.value?(this.setColor(this.input.value),this.input.value=this.value,this.value!==e&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),setTimeout(()=>this.input.select())):this.hue=0}}handleTouchMove(t){t.preventDefault()}parseColor(t){if(!t||t.trim()==="")return null;let e=new lt(t);if(!e.isValid)return null;let i=e.toHsl(),r=e.toRgb(),a=e.toHsv();if(!r||r.r==null||r.g==null||r.b==null)return null;let n={h:i.h||0,s:(i.s||0)*100,l:(i.l||0)*100,a:i.a||0},l=e.toHexString(),h=e.toHex8String(),u={h:a.h||0,s:(a.s||0)*100,v:(a.v||0)*100,a:a.a||0};return{hsl:{h:n.h,s:n.s,l:n.l,string:this.setLetterCase(`hsl(${Math.round(n.h)}, ${Math.round(n.s)}%, ${Math.round(n.l)}%)`)},hsla:{h:n.h,s:n.s,l:n.l,a:n.a,string:this.setLetterCase(`hsla(${Math.round(n.h)}, ${Math.round(n.s)}%, ${Math.round(n.l)}%, ${n.a.toFixed(2).toString()})`)},hsv:{h:u.h,s:u.s,v:u.v,string:this.setLetterCase(`hsv(${Math.round(u.h)}, ${Math.round(u.s)}%, ${Math.round(u.v)}%)`)},hsva:{h:u.h,s:u.s,v:u.v,a:u.a,string:this.setLetterCase(`hsva(${Math.round(u.h)}, ${Math.round(u.s)}%, ${Math.round(u.v)}%, ${u.a.toFixed(2).toString()})`)},rgb:{r:r.r,g:r.g,b:r.b,string:this.setLetterCase(`rgb(${Math.round(r.r)}, ${Math.round(r.g)}, ${Math.round(r.b)})`)},rgba:{r:r.r,g:r.g,b:r.b,a:r.a||0,string:this.setLetterCase(`rgba(${Math.round(r.r)}, ${Math.round(r.g)}, ${Math.round(r.b)}, ${(r.a||0).toFixed(2).toString()})`)},hex:this.setLetterCase(l),hexa:this.setLetterCase(h)}}setColor(t){let e=this.parseColor(t);return e===null?!1:(this.hue=e.hsva.h,this.saturation=e.hsva.s,this.brightness=e.hsva.v,this.alpha=this.opacity?e.hsva.a*100:100,this.syncValues(),!0)}setLetterCase(t){return typeof t!="string"?"":this.uppercase?t.toUpperCase():t.toLowerCase()}async syncValues(){let t=this.parseColor(`hsva(${this.hue}, ${this.saturation}%, ${this.brightness}%, ${this.alpha/100})`);t!==null&&(this.format==="hsl"?this.inputValue=this.opacity?t.hsla.string:t.hsl.string:this.format==="rgb"?this.inputValue=this.opacity?t.rgba.string:t.rgb.string:this.format==="hsv"?this.inputValue=this.opacity?t.hsva.string:t.hsv.string:this.inputValue=this.opacity?t.hexa:t.hex,this.isSafeValue=!0,this.value=this.inputValue,await this.updateComplete,this.isSafeValue=!1)}handleAfterHide(){this.previewButton.classList.remove("preview-color-copied"),this.updateValidity()}handleAfterShow(){this.updateValidity()}handleEyeDropper(){if(!this.hasEyeDropper)return;new EyeDropper().open().then(e=>{let i=this.value;this.setColor(e.sRGBHex),this.value!==i&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}).catch(()=>{})}selectSwatch(t){let e=this.value;this.disabled||(this.setColor(t),this.value!==e&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))}getHexString(t,e,i,r=100){let a=new lt(`hsva(${t}, ${e}%, ${i}%, ${r/100})`);return a.isValid?a.toHex8String():""}stopNestedEventPropagation(t){t.stopImmediatePropagation()}handleFormatChange(){this.syncValues()}handleOpacityChange(){this.alpha=100}willUpdate(t){(t.has("value")||t.has("defaultValue"))&&this.handleValueChange(t.get("value")||"",this.value||""),super.willUpdate(t)}handleValueChange(t,e){if(this.isEmpty=!e,e||(this.hue=0,this.saturation=0,this.brightness=100,this.alpha=100),!this.isSafeValue){let i=this.parseColor(e);i!==null?(this.inputValue=this.value||"",this.hue=i.hsva.h,this.saturation=i.hsva.s,this.brightness=i.hsva.v,this.alpha=this.opacity?i.hsva.a*100:100,this.syncValues()):this.inputValue=t??""}this.requestUpdate()}focus(t){this.trigger.focus(t)}blur(){let t=this.trigger;this.hasFocus&&(t.focus({preventScroll:!0}),t.blur()),this.popup?.active&&this.hide()}getFormattedValue(t="hex"){let e=this.parseColor(`hsva(${this.hue}, ${this.saturation}%, ${this.brightness}%, ${this.alpha/100})`);if(e===null)return"";switch(t){case"hex":return e.hex;case"hexa":return e.hexa;case"rgb":return e.rgb.string;case"rgba":return e.rgba.string;case"hsl":return e.hsl.string;case"hsla":return e.hsla.string;case"hsv":return e.hsv.string;case"hsva":return e.hsva.string;default:return""}}reportValidity(){return!this.validity.valid&&!this.open?(this.addEventListener("wa-after-show",this.reportValidityAfterShow,{once:!0}),this.show(),this.disabled||this.dispatchEvent(new bt),!1):super.reportValidity()}formResetCallback(){this.value=this.defaultValue,super.formResetCallback()}firstUpdated(t){super.firstUpdated(t),this.hasEyeDropper="EyeDropper"in window}handleTriggerClick(){this.open?this.hide():(this.show(),this.focus())}async handleTriggerKeyDown(t){if([" ","Enter"].includes(t.key)){t.preventDefault(),this.handleTriggerClick();return}}handleTriggerKeyUp(t){t.key===" "&&t.preventDefault()}updateAccessibleTrigger(){let t=this.trigger;t&&(t.setAttribute("aria-haspopup","true"),t.setAttribute("aria-expanded",this.open?"true":"false"))}async show(){if(!this.open)return this.open=!0,J(this,"wa-after-show")}async hide(){if(this.open)return this.open=!1,J(this,"wa-after-hide")}addOpenListeners(){this.base.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown),pt(this)}removeOpenListeners(){this.base&&this.base.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),mt(this)}async handleOpenChange(){if(this.disabled){this.open=!1;return}this.updateAccessibleTrigger(),this.open?(this.dispatchEvent(new CustomEvent("wa-show")),this.addOpenListeners(),await this.updateComplete,this.base.hidden=!1,this.popup.active=!0,await Q(this.popup.popup,"show-with-scale"),this.dispatchEvent(new CustomEvent("wa-after-show"))):(this.dispatchEvent(new CustomEvent("wa-hide")),this.removeOpenListeners(),await Q(this.popup.popup,"hide-with-scale"),this.base.hidden=!0,this.popup.active=!1,this.dispatchEvent(new CustomEvent("wa-after-hide")))}render(){let t=this.isEmpty,e=this.hasSlotController.test("label","withLabel"),i=this.hasSlotController.test("hint","withHint"),r=this.label?!0:!!e,a=this.hint?!0:!!i,n=this.saturation,l=100-this.brightness,h=Array.isArray(this.swatches)?this.swatches.map(p=>typeof p=="string"?{color:p,label:p}:p):this.swatches.split(";").filter(p=>p.trim()!=="").map(p=>({color:p.trim(),label:p.trim()})),u=d`
      <div
        part="base color-picker"
        class=${C({"color-picker":!0})}
      ...
      >
        ...
        >
          <span
            part="grid-handle"
            class=${C({"grid-handle":!0,"grid-handle-dragging":this.isDraggingGridHandle})}
            style=${T({top:`${l}%`,left:`${n}%`,backgroundColor:this.getHexString(this.hue,this.saturation,this.brightness,this.alpha)})}
            role="application"
            aria-label="HSV"
          ...
          <div class="sliders">
            ...
            >
              <span
                ...
                class="slider-handle"
                style=${T({left:`${this.hue===0?0:100/(360/this.hue)}%`,backgroundColor:this.getHexString(this.hue,100,100)})}
                role="slider"
                aria-label="hue"
            ...
            ${this.opacity?d`
                  ...
                  >
                    ...
                    <span
                      ...
                      class="slider-handle"
                      style=${T({left:`${this.alpha}%`,backgroundColor:this.getHexString(this.hue,this.saturation,this.brightness,this.alpha)})}
                      role="slider"
                      aria-label="alpha"
                      aria-orientation="horizontal"
                      aria-valuemin="0"
              ...
              <div part="swatches" class="swatches">
                ${h.map(p=>{let V=this.parseColor(p.color);return V?d`
                    <div
                      ...
                      @keydown=${M=>{(M.key==="Enter"||M.key===" ")&&(M.preventDefault(),this.selectSwatch(p.color))}}
                    >
                      <div class="swatch-color" style=${T({backgroundColor:V.hexa})}></div>
                    </div>
                  `:""})}
              </div>
            `:""}
    ...
    `;return d`
      <div
        class=${C({container:!0,"form-control":!0,"form-control-has-label":r})}
      ...
      >
        ...
        <button
          ...
          class=${C({trigger:!0,"trigger-empty":t,"transparent-bg":!0,"form-control-input":!0})}
    ...
    `}};c.css=[ct,O,B,Gt];c.shadowRootOptions={...A.shadowRootOptions,delegatesFocus:!0};o([f('[part~="base"]')],c.prototype,"base",2);o([f('[part~="input"]')],c.prototype,"input",2);o([f('[part~="form-control-label"]')],c.prototype,"triggerLabel",2);o([f('[part~="form-control-input"]')],c.prototype,"triggerButton",2);o([f(".color-popup")],c.prototype,"popup",2);o([f('[part~="preview"]')],c.prototype,"previewButton",2);o([f('[part~="trigger"]')],c.prototype,"trigger",2);o([x()],c.prototype,"hasFocus",2);o([x()],c.prototype,"isDraggingGridHandle",2);o([x()],c.prototype,"inputValue",2);o([x()],c.prototype,"hue",2);o([x()],c.prototype,"isEmpty",2);o([x()],c.prototype,"saturation",2);o([x()],c.prototype,"brightness",2);o([x()],c.prototype,"alpha",2);o([x()],c.prototype,"value",1);o([s({attribute:"value",reflect:!0})],c.prototype,"defaultValue",2);o([s({attribute:"with-label",reflect:!0,type:Boolean})],c.prototype,"withLabel",2);o([s({attribute:"with-hint",reflect:!0,type:Boolean})],c.prototype,"withHint",2);o([x()],c.prototype,"hasEyeDropper",2);o([s()],c.prototype,"label",2);o([s({attribute:"hint"})],c.prototype,"hint",2);o([s()],c.prototype,"format",2);o([s({reflect:!0})],c.prototype,"size",2);o([y("size")],c.prototype,"handleSizeChange",1);o([s({reflect:!0})],c.prototype,"placement",2);o([s({attribute:"without-format-toggle",type:Boolean})],c.prototype,"withoutFormatToggle",2);o([s({reflect:!0})],c.prototype,"name",2);o([s({type:Boolean})],c.prototype,"disabled",2);o([s({type:Boolean,reflect:!0})],c.prototype,"open",2);o([s({type:Boolean})],c.prototype,"opacity",2);o([s({type:Boolean})],c.prototype,"uppercase",2);o([s()],c.prototype,"swatches",2);o([s({type:Boolean,reflect:!0})],c.prototype,"required",2);o([Nt({passive:!1})],c.prototype,"handleTouchMove",1);o([y("format",{waitUntilFirstUpdate:!0})],c.prototype,"handleFormatChange",1);o([y("opacity",{waitUntilFirstUpdate:!0})],c.prototype,"handleOpacityChange",1);o([y("value")],c.prototype,"handleValueChange",1);o([y("open",{waitUntilFirstUpdate:!0})],c.prototype,"handleOpenChange",1);c=o([E("wa-color-picker")],c);c.disableWarning?.("change-in-update");/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var re=S`
  :host {
    display: inline-flex;
  }
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var Y=class extends W{constructor(){super(...arguments),this.disableRole=!1,this.hasOutlined=!1,this.label="",this.orientation="horizontal"}updated(t){super.updated(t),t.has("orientation")&&this.setAttribute("aria-orientation",this.orientation)}handleFocus(t){$t(t.target)?.classList.add("button-focus")}handleBlur(t){$t(t.target)?.classList.remove("button-focus")}handleMouseOver(t){$t(t.target)?.classList.add("button-hover")}handleMouseOut(t){$t(t.target)?.classList.remove("button-hover")}render(){return d`
      <slot
        part="base"
        class="button-group"
      ...
      ></slot>
    `}};Y.css=[re];o([f("slot")],Y.prototype,"defaultSlot",2);o([x()],Y.prototype,"disableRole",2);o([x()],Y.prototype,"hasOutlined",2);o([s()],Y.prototype,"label",2);o([s({reflect:!0})],Y.prototype,"orientation",2);Y=o([E("wa-button-group")],Y);function $t(t){let e="wa-button, wa-radio-button";return t.closest(e)??t.querySelector(e)}/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var oe=S`
  @layer wa-component {
    :host {
      display: inline-block;
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var Ct=S`
  :where(:root),
  .wa-neutral,
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var se=Symbol.for(""),Se=t=>{if(t?.r===se)return t?._$litStatic$};var Rt=(t,...e)=>({_$litStatic$:e.reduce((i,r,a)=>i+(n=>{if(n._$litStatic$!==void 0)return n._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${n}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(r)+t[a+1],t[0]),r:se}),ae=new Map,Lt=t=>(e,...i)=>{let r=i.length,a,n,l=[],h=[],u,p=0,V=!1;for(;p<r;){for(u=e[p];p<r&&(n=i[p],(a=Se(n))!==void 0);)u+=a+e[++p],V=!0;p!==r&&h.push(n),l.push(u),p++}if(p===r&&l.push(e[r]),V){let M=l.join("$$lit$$");(e=ae.get(M))===void 0&&(l.raw=l,ae.set(M,e=l)),i=h}return t(e,...i)},St=Lt(d),Oi=Lt(Bt),Hi=Lt(It);/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var w=class extends A{constructor(){super(...arguments),this.assumeInteractionOn=["click"],this.hasSlotController=new H(this,"[default]","start","end"),this.localize=new z(this),this.invalid=!1,this.isIconButton=!1,this.title="",this.variant="neutral",this.appearance="accent",this.size="m",this.withCaret=!1,this.withStart=!1,this.withEnd=!1,this.disabled=!1,this.loading=!1,this.pill=!1,this.type="button"}static get validators(){return[...super.validators,j()]}handleSizeChange(){L(this.localName,this.size)}constructLightDOMButton(){let t=document.createElement("button");for(let e of this.attributes)e.name!=="style"&&t.setAttribute(e.name,e.value);return t.type=this.type,t.style.position="absolute !important",t.style.width="0 !important",t.style.height="0 !important",t.style.clipPath="inset(50%) !important",t.style.overflow="hidden !important",t.style.whiteSpace="nowrap !important",this.name&&(t.name=this.name),t.value=this.value||"",t}handleClick(t){if(this.disabled||this.loading){t.preventDefault(),t.stopImmediatePropagation();return}if(this.type!=="submit"&&this.type!=="reset"||!this.getForm())return;let i=this.constructLightDOMButton();this.parentElement?.append(i),i.click(),i.remove()}handleInvalid(){this.dispatchEvent(new bt)}handleLabelSlotChange(){let t=this.labelSlot.assignedNodes({flatten:!0}),e=!1,i=!1,r=!1,a=!1;[...t].forEach(n=>{if(n.nodeType===Node.ELEMENT_NODE){let l=n;l.localName==="wa-icon"?(i=!0,e||(e=l.label!==void 0)):a=!0}else n.nodeType===Node.TEXT_NODE&&(n.textContent?.trim()||"").length>0&&(r=!0)}),this.isIconButton=i&&!r&&!a,this.customStates.set("icon-button",this.isIconButton),this.isIconButton&&!e&&console.warn('Icon buttons must have a label for screen readers. Add <wa-icon label="..."> to remove this warning.',this)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.customStates.set("disabled",this.disabled),this.updateValidity()}handleHrefChange(){this.customStates.set("link",this.isLink())}handleLoadingChange(){this.customStates.set("loading",this.loading)}setValue(...t){}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){let t=this.isLink(),e=t?Rt`a`:Rt`button`;return St`
      <${e}
        part="base button"
        class=${C({button:!0,caret:this.withCaret,disabled:this.disabled,loading:this.loading,rtl:this.localize.dir()==="rtl","has-label":this.hasSlotController.test("[default]"),"has-start":this.hasSlotController.test("start","withStart"),"has-end":this.hasSlotController.test("end","withEnd"),"is-icon-button":this.isIconButton})}
    ...
    `}};w.shadowRootOptions={...A.shadowRootOptions,delegatesFocus:!0};w.css=[oe,Ct,O];o([f(".button")],w.prototype,"button",2);o([f("slot:not([name])")],w.prototype,"labelSlot",2);o([x()],w.prototype,"invalid",2);o([x()],w.prototype,"isIconButton",2);o([s()],w.prototype,"title",2);o([s({reflect:!0})],w.prototype,"variant",2);o([s({reflect:!0})],w.prototype,"appearance",2);o([s({reflect:!0})],w.prototype,"size",2);o([y("size")],w.prototype,"handleSizeChange",1);o([s({attribute:"with-caret",type:Boolean,reflect:!0})],w.prototype,"withCaret",2);o([s({attribute:"with-start",type:Boolean})],w.prototype,"withStart",2);o([s({attribute:"with-end",type:Boolean})],w.prototype,"withEnd",2);o([s({type:Boolean})],w.prototype,"disabled",2);o([s({type:Boolean,reflect:!0})],w.prototype,"loading",2);o([s({type:Boolean,reflect:!0})],w.prototype,"pill",2);o([s()],w.prototype,"type",2);o([s({reflect:!0})],w.prototype,"name",2);o([s({reflect:!0})],w.prototype,"value",2);o([s({reflect:!0})],w.prototype,"href",2);o([s()],w.prototype,"target",2);o([s()],w.prototype,"rel",2);o([s()],w.prototype,"download",2);o([s({attribute:"formaction"})],w.prototype,"formAction",2);o([s({attribute:"formenctype"})],w.prototype,"formEnctype",2);o([s({attribute:"formmethod"})],w.prototype,"formMethod",2);o([s({attribute:"formnovalidate",type:Boolean})],w.prototype,"formNoValidate",2);o([s({attribute:"formtarget"})],w.prototype,"formTarget",2);o([y("disabled",{waitUntilFirstUpdate:!0})],w.prototype,"handleDisabledChange",1);o([y("href")],w.prototype,"handleHrefChange",1);o([y("loading",{waitUntilFirstUpdate:!0})],w.prototype,"handleLoadingChange",1);w=o([E("wa-button")],w);w.disableWarning?.("change-in-update");/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var ne=S`
  :host {
    --track-width: 2px;
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var Ot=class extends W{constructor(){super(...arguments),this.localize=new z(this)}render(){return d`
      <svg
        part="base spinner"
        role="progressbar"
    ...
    `}};Ot.css=ne;Ot=o([E("wa-spinner")],Ot);/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license *//*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var le=S`
  :host {
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var Z=class extends W{constructor(){super(...arguments),this.localize=new z(this),this.position=50}handleDrag(t){let{width:e}=this.getBoundingClientRect(),i=this.localize.dir()==="rtl";t.preventDefault(),et(this,{onMove:r=>{this.customStates.set("dragging",!0),this.position=parseFloat($(r/e*100,0,100).toFixed(2)),i&&(this.position=100-this.position)},onStop:()=>{this.customStates.set("dragging",!1)},initialEvent:t})}handleKeyDown(t){let e=this.matches(":dir(ltr)"),i=this.localize.dir()==="rtl";if(["ArrowLeft","ArrowRight","Home","End"].includes(t.key)){let r=t.shiftKey?10:1,a=this.position;t.preventDefault(),(e&&t.key==="ArrowLeft"||i&&t.key==="ArrowRight")&&(a-=r),(e&&t.key==="ArrowRight"||i&&t.key==="ArrowLeft")&&(a+=r),t.key==="Home"&&(a=0),t.key==="End"&&(a=100),a=$(a,0,100),this.position=a}}handlePositionChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}render(){let t=this.hasUpdated?this.localize.dir()==="rtl":this.dir==="rtl";return d`
    ...
    `}};Z.css=le;o([f(".handle")],Z.prototype,"handle",2);o([s({type:Number,reflect:!0})],Z.prototype,"position",2);o([y("position",{waitUntilFirstUpdate:!0})],Z.prototype,"handlePositionChange",1);Z=o([E("wa-comparison")],Z);/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license *//*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var he=S`
  :host {
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var D=class extends A{constructor(){super(...arguments),this.hasSlotController=new H(this,"hint"),this.localize=new z(this),this.title="",this.name=null,this._value=this.getAttribute("value")??null,this.size="m",this.disabled=!1,this._checked=null,this.defaultChecked=this.hasAttribute("checked"),this.required=!1,this.hint="",this.withHint=!1}static get validators(){return[...super.validators,j()]}get value(){return this._value??"on"}set value(t){this._value=t}handleSizeChange(){L(this.localName,this.size)}get checked(){return this.valueHasChanged?!!this._checked:this._checked??this.defaultChecked}set checked(t){this._checked=!!t,this.valueHasChanged=!0}handleClick(){this.hasInteracted=!0,this.checked=!this.checked,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}handleKeyDown(t){let e=this.localize.dir()==="rtl";t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=e,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))})),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=!e,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))}))}willUpdate(t){super.willUpdate(t),(t.has("value")||t.has("checked")||t.has("defaultChecked")||t.has("disabled"))&&this.handleValueOrCheckedChange()}handleValueOrCheckedChange(){if(this.didSSR&&!this.hasUpdated){this.updateComplete.then(()=>{this.handleValueOrCheckedChange()});return}this.setValue(this.checked?this.value:null,this._value),this.updateValidity()}handleStateChange(){this.hasUpdated&&(this.input.checked=this.checked),this.customStates.set("checked",this.checked),this.updateValidity()}handleDisabledChange(){this.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}setValue(t,e){if(!this.checked){this.internals.setFormValue(null,null);return}this.internals.setFormValue(t??"on",e)}formResetCallback(){this._checked=null,super.formResetCallback(),this.handleValueOrCheckedChange()}render(){let t=this.hasSlotController.test("hint","withHint"),e=this.hint?!0:!!t,i=this.didSSR&&!this.hasUpdated?this.checked:this.defaultChecked,r=this.didSSR&&!this.hasUpdated?null:tt(this.checked);return d`
      ...
      <slot
        ...
        >${this.hint}</slot
      >
    `}};D.shadowRootOptions={...A.shadowRootOptions,delegatesFocus:!0};D.css=[B,O,he];o([f('input[type="checkbox"]')],D.prototype,"input",2);o([s()],D.prototype,"title",2);o([s({reflect:!0})],D.prototype,"name",2);o([s({reflect:!0})],D.prototype,"value",1);o([s({reflect:!0})],D.prototype,"size",2);o([y("size")],D.prototype,"handleSizeChange",1);o([s({type:Boolean})],D.prototype,"disabled",2);o([s({type:Boolean,attribute:!1})],D.prototype,"checked",1);o([s({type:Boolean,attribute:"checked",reflect:!0})],D.prototype,"defaultChecked",2);o([s({type:Boolean,reflect:!0})],D.prototype,"required",2);o([s({attribute:"hint"})],D.prototype,"hint",2);o([s({attribute:"with-hint",type:Boolean})],D.prototype,"withHint",2);o([y(["checked","defaultChecked"])],D.prototype,"handleStateChange",1);o([y("disabled",{waitUntilFirstUpdate:!0})],D.prototype,"handleDisabledChange",1);D=o([E("wa-switch")],D);D.disableWarning?.("change-in-update");/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license *//*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var ue=S`
  :host {
    --track-size: 0.5em;
    --thumb-width: 1.4em;
    --thumb-height: 1.4em;
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function*Ht(t=document.activeElement){t!=null&&(yield t,"shadowRoot"in t&&t.shadowRoot&&t.shadowRoot.mode!=="closed"&&(yield*Ht(t.shadowRoot.activeElement)))}/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function qt(t,e,i){let r=(t-e)/i;return Math.abs(r-Math.round(r))>1e-9}var Ee=()=>({observedAttributes:["min","max","step"],checkValidity(t){let e={message:"",isValid:!0,invalidKeys:[]},i=(r,a,n,l)=>{if(typeof document>"u")return"";let h=document.createElement("input");return h.type="range",h.min=String(a),h.max=String(n),h.step=String(l),h.value=String(r),h.checkValidity(),h.validationMessage};if(t.isRange){let r=t.minValue,a=t.maxValue;if(r<t.min)return e.isValid=!1,e.invalidKeys.push("rangeUnderflow"),e.message=i(r,t.min,t.max,t.step)||`Value must be greater than or equal to ${t.min}.`,e;if(a>t.max)return e.isValid=!1,e.invalidKeys.push("rangeOverflow"),e.message=i(a,t.min,t.max,t.step)||`Value must be less than or equal to ${t.max}.`,e;if(t.step&&t.step!==1){let n=qt(r,t.min,t.step),l=qt(a,t.min,t.step);if(n||l){e.isValid=!1,e.invalidKeys.push("stepMismatch");let h=n?r:a;return e.message=i(h,t.min,t.max,t.step)||`Value must be a multiple of ${t.step}.`,e}}}else{let r=t.value;if(r<t.min)return e.isValid=!1,e.invalidKeys.push("rangeUnderflow"),e.message=i(r,t.min,t.max,t.step)||`Value must be greater than or equal to ${t.min}.`,e;if(r>t.max)return e.isValid=!1,e.invalidKeys.push("rangeOverflow"),e.message=i(r,t.min,t.max,t.step)||`Value must be less than or equal to ${t.max}.`,e;if(t.step&&t.step!==1&&qt(r,t.min,t.step))return e.isValid=!1,e.invalidKeys.push("stepMismatch"),e.message=i(r,t.min,t.max,t.step)||`Value must be a multiple of ${t.step}.`,e}return e}}),v=class extends A{constructor(){super(...arguments),this.draggableThumbMin=null,this.draggableThumbMax=null,this.hasSlotController=new H(this,"hint","label"),this.localize=new z(this),this.activeThumb=null,this.lastTrackPosition=null,this.label="",this.hint="",this.minValue=0,this.maxValue=50,this.defaultValue=this.getAttribute("value")==null?this.minValue:Number(this.getAttribute("value")),this._value=null,this.range=!1,this.disabled=!1,this.readonly=!1,this.orientation="horizontal",this.size="m",this.min=0,this.max=100,this.step=1,this.tooltipDistance=8,this.tooltipPlacement="top",this.withMarkers=!1,this.withTooltip=!1,this.withLabel=!1,this.withHint=!1}static get validators(){return[...super.validators,Ee()]}get focusableAnchor(){return this.isRange?this.thumbMin||this.slider:this.slider}get validationTarget(){return this.focusableAnchor}get value(){if(this.valueHasChanged){let e=this._value??this.minValue??0;return $(e,this.min,this.max)}let t=this._value??this.defaultValue;return $(t,this.min,this.max)}set value(t){t=Number(t)??this.minValue,this._value!==t&&(this.valueHasChanged=!0,this._value=t)}get isRange(){return this.range}handleSizeChange(){L(this.localName,this.size)}firstUpdated(t){super.firstUpdated(t),this.isRange?(this.draggableThumbMin=new ot(this.thumbMin,{start:()=>{this.activeThumb="min",this.trackBoundingClientRect=this.track.getBoundingClientRect(),this.valueWhenDraggingStarted=this.minValue,this.customStates.set("dragging",!0),this.showRangeTooltips()},move:(e,i)=>{this.setThumbValueFromCoordinates(e,i,"min")},stop:()=>{this.minValue!==this.valueWhenDraggingStarted&&(this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.hasInteracted=!0),this.hideRangeTooltips(),this.customStates.set("dragging",!1),this.valueWhenDraggingStarted=void 0,this.activeThumb=null}}),this.draggableThumbMax=new ot(this.thumbMax,{start:()=>{this.activeThumb="max",this.trackBoundingClientRect=this.track.getBoundingClientRect(),this.valueWhenDraggingStarted=this.maxValue,this.customStates.set("dragging",!0),this.showRangeTooltips()},move:(e,i)=>{this.setThumbValueFromCoordinates(e,i,"max")},stop:()=>{this.maxValue!==this.valueWhenDraggingStarted&&(this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.hasInteracted=!0),this.hideRangeTooltips(),this.customStates.set("dragging",!1),this.valueWhenDraggingStarted=void 0,this.activeThumb=null}}),this.draggableTrack=new ot(this.track,{start:(e,i)=>{if(this.trackBoundingClientRect=this.track.getBoundingClientRect(),this.activeThumb)this.valueWhenDraggingStarted=this.activeThumb==="min"?this.minValue:this.maxValue;else{let r=this.getValueFromCoordinates(e,i),a=Math.abs(r-this.minValue),n=Math.abs(r-this.maxValue);if(a===n)if(r>this.maxValue)this.activeThumb="max";else if(r<this.minValue)this.activeThumb="min";else{let l=this.localize.dir()==="rtl",h=this.orientation==="vertical",u=h?i:e,p=this.lastTrackPosition||u;this.lastTrackPosition=u;let V=u>p!==l&&!h||u<p&&h;this.activeThumb=V?"max":"min"}else this.activeThumb=a<=n?"min":"max";this.valueWhenDraggingStarted=this.activeThumb==="min"?this.minValue:this.maxValue}this.customStates.set("dragging",!0),this.setThumbValueFromCoordinates(e,i,this.activeThumb),this.showRangeTooltips()},move:(e,i)=>{this.activeThumb&&this.setThumbValueFromCoordinates(e,i,this.activeThumb)},stop:()=>{this.activeThumb&&(this.activeThumb==="min"?this.minValue:this.maxValue)!==this.valueWhenDraggingStarted&&(this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.hasInteracted=!0),this.hideRangeTooltips(),this.customStates.set("dragging",!1),this.valueWhenDraggingStarted=void 0,this.activeThumb=null}})):this.draggableTrack=new ot(this.slider,{start:(e,i)=>{this.trackBoundingClientRect=this.track.getBoundingClientRect(),this.valueWhenDraggingStarted=this.value,this.customStates.set("dragging",!0),this.setValueFromCoordinates(e,i),this.showTooltip()},move:(e,i)=>{this.setValueFromCoordinates(e,i)},stop:()=>{this.value!==this.valueWhenDraggingStarted&&(this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.hasInteracted=!0),this.hideTooltip(),this.customStates.set("dragging",!1),this.valueWhenDraggingStarted=void 0}})}willUpdate(t){this.isRange&&(t.has("minValue")||t.has("maxValue")||t.has("min")||t.has("max"))&&(this.minValue=$(this.minValue,this.min,this.maxValue),this.maxValue=$(this.maxValue,this.minValue,this.max)),super.willUpdate(t)}updated(t){if(this.isRange&&(t.has("minValue")||t.has("maxValue"))&&this.updateFormValue(),t.has("disabled")||t.has("readonly")){let e=!(this.disabled||this.readonly);this.isRange&&(this.draggableThumbMin&&this.draggableThumbMin.toggle(e),this.draggableThumbMax&&this.draggableThumbMax.toggle(e)),this.draggableTrack&&this.draggableTrack.toggle(e)}super.updated(t)}formDisabledCallback(t){this.disabled=t}formResetCallback(){this.isRange?(this.minValue=parseFloat(this.getAttribute("min-value")??String(this.min)),this.maxValue=parseFloat(this.getAttribute("max-value")??String(this.max))):(this._value=null,this.defaultValue=this.defaultValue??parseFloat(this.getAttribute("value")??String(this.min))),this.valueHasChanged=!1,this.hasInteracted=!1,super.formResetCallback()}clampAndRoundToStep(t){let e=(String(this.step).split(".")[1]||"").replace(/0+$/g,"").length,i=Number(this.step),r=Number(this.min),a=Number(this.max);return t=Math.round(t/i)*i,t=$(t,r,a),parseFloat(t.toFixed(e))}getPercentageFromValue(t){return(t-this.min)/(this.max-this.min)*100}getValueFromCoordinates(t,e){let i=this.localize.dir()==="rtl",r=this.orientation==="vertical",{top:a,right:n,bottom:l,left:h,height:u,width:p}=this.trackBoundingClientRect,V=r?e:t,M=r?{start:a,end:l,size:u}:{start:h,end:n,size:p},U=(r||i?M.end-V:V-M.start)/M.size;return this.clampAndRoundToStep(this.min+(this.max-this.min)*U)}handleBlur(){this.isRange?requestAnimationFrame(()=>{let t=this.shadowRoot?.activeElement;t===this.thumbMin||t===this.thumbMax||this.hideRangeTooltips()}):this.hideTooltip(),this.customStates.set("focused",!1),this.dispatchEvent(new FocusEvent("blur",{bubbles:!0,composed:!0}))}handleFocus(t){let e=t.target;this.isRange?(e===this.thumbMin?this.activeThumb="min":e===this.thumbMax&&(this.activeThumb="max"),this.showRangeTooltips()):this.showTooltip(),this.customStates.set("focused",!0),this.dispatchEvent(new FocusEvent("focus",{bubbles:!0,composed:!0}))}handleKeyDown(t){let e=this.localize.dir()==="rtl",i=t.target;if(this.disabled||this.readonly||this.isRange&&(i===this.thumbMin?this.activeThumb="min":i===this.thumbMax&&(this.activeThumb="max"),!this.activeThumb))return;let r=this.isRange?this.activeThumb==="min"?this.minValue:this.maxValue:this.value,a=r;switch(t.key){case"ArrowUp":case(e?"ArrowLeft":"ArrowRight"):t.preventDefault(),a=this.clampAndRoundToStep(r+this.step);break;case"ArrowDown":case(e?"ArrowRight":"ArrowLeft"):t.preventDefault(),a=this.clampAndRoundToStep(r-this.step);break;case"Home":t.preventDefault(),a=this.isRange&&this.activeThumb==="min"?this.min:this.isRange?this.minValue:this.min;break;case"End":t.preventDefault(),a=this.isRange&&this.activeThumb==="max"?this.max:this.isRange?this.maxValue:this.max;break;case"PageUp":t.preventDefault();let n=Math.max(r+(this.max-this.min)/10,r+this.step);a=this.clampAndRoundToStep(n);break;case"PageDown":t.preventDefault();let l=Math.min(r-(this.max-this.min)/10,r-this.step);a=this.clampAndRoundToStep(l);break;case"Enter":yt(t,this);return}a!==r&&(this.isRange?(this.activeThumb==="min"?a>this.maxValue?(this.maxValue=a,this.minValue=a):this.minValue=Math.max(this.min,a):a<this.minValue?(this.minValue=a,this.maxValue=a):this.maxValue=Math.min(this.max,a),this.updateFormValue()):this.value=$(a,this.min,this.max),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.hasInteracted=!0)}handleLabelPointerDown(t){t.preventDefault(),this.disabled||(this.isRange?this.thumbMin?.focus():this.slider.focus())}setValueFromCoordinates(t,e){let i=this.value;this.value=this.getValueFromCoordinates(t,e),this.value!==i&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))})}setThumbValueFromCoordinates(t,e,i){let r=this.getValueFromCoordinates(t,e),a=i==="min"?this.minValue:this.maxValue;i==="min"?r>this.maxValue?(this.maxValue=r,this.minValue=r):this.minValue=Math.max(this.min,r):r<this.minValue?(this.minValue=r,this.maxValue=r):this.maxValue=Math.min(this.max,r),a!==(i==="min"?this.minValue:this.maxValue)&&(this.updateFormValue(),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))}))}showTooltip(){this.withTooltip&&this.tooltip&&(this.tooltip.open=!0)}hideTooltip(){this.withTooltip&&this.tooltip&&(this.tooltip.open=!1)}showRangeTooltips(){if(!this.withTooltip)return;let t=this.shadowRoot?.getElementById("tooltip-thumb-min"),e=this.shadowRoot?.getElementById("tooltip-thumb-max");this.activeThumb==="min"?(t&&(t.open=!0),e&&(e.open=!1)):this.activeThumb==="max"&&(e&&(e.open=!0),t&&(t.open=!1))}hideRangeTooltips(){if(!this.withTooltip)return;let t=this.shadowRoot?.getElementById("tooltip-thumb-min"),e=this.shadowRoot?.getElementById("tooltip-thumb-max");t&&(t.open=!1),e&&(e.open=!1)}updateFormValue(t){if(this.isRange){let e=new FormData;e.append(this.name||"",String(this.minValue)),e.append(this.name||"",String(this.maxValue)),this.setValue(e,e);return}super.updateFormValue(t)}focus(){this.isRange?this.thumbMin?.focus():this.slider.focus()}blur(){if(this.isRange){for(let t of Ht())if(t===this.thumbMin){this.thumbMin.blur();break}else if(t===this.thumbMax){this.thumbMax.blur();break}}else this.slider.blur()}stepDown(){if(this.isRange){let t=this.clampAndRoundToStep(this.minValue-this.step);this.minValue=$(t,this.min,this.maxValue),this.updateFormValue()}else{let t=this.clampAndRoundToStep(this.value-this.step);this.value=t}}stepUp(){if(this.isRange){let t=this.clampAndRoundToStep(this.maxValue+this.step);this.maxValue=$(t,this.minValue,this.max),this.updateFormValue()}else{let t=this.clampAndRoundToStep(this.value+this.step);this.value=t}}render(){let t=this.hasSlotController.test("label","withLabel"),e=this.hasSlotController.test("hint","withHint"),i=this.label?!0:!!t,r=this.hint?!0:!!e,a=this.hasSlotController.test("reference"),n=C({xs:this.size==="xs",s:this.size==="s"||this.size==="small",m:this.size==="m"||this.size==="medium",l:this.size==="l"||this.size==="large",xl:this.size==="xl",small:this.size==="small"||this.size==="s",medium:this.size==="medium"||this.size==="m",large:this.size==="large"||this.size==="l",horizontal:this.orientation==="horizontal",vertical:this.orientation==="vertical",disabled:this.disabled}),l=[];if(this.withMarkers)for(let R=this.min;R<=this.max;R+=this.step)l.push(this.getPercentageFromValue(R));let h=d`
    ...
    `,p=this.withMarkers?d`
          <div id="markers" part="markers">
            ${l.map(R=>d`<span part="marker" class="marker" style=${T({"--position":`${R}%`})}></span>`)}
          </div>
        `:"",V=a?d`
          <div id="references" part="references" aria-hidden="true">
            <slot name="reference"></slot>
          </div>
        `:"",M=(R,U)=>this.withTooltip?d`
            <wa-tooltip
              id=${`tooltip${R!=="thumb"?"-"+R:""}`}
              part="tooltip"
              exportparts="
                base:tooltip__base,
          ...
          `:"";if(this.isRange){let R=$(this.getPercentageFromValue(this.minValue),0,100),U=$(this.getPercentageFromValue(this.maxValue),0,100);return d`
        ${h}
        ...
        <div id="slider" part="slider" class=${n}>
          <div id="track" part="track">
            <div
              id="indicator"
              part="indicator"
              style=${T({"--start":`${Math.min(R,U)}%`,"--end":`${Math.max(R,U)}%`})}
            ></div>
      ...
      `}else{let R=$(this.getPercentageFromValue(this.value),0,100),U=$(this.getPercentageFromValue(typeof this.indicatorOffset=="number"?this.indicatorOffset:this.min),0,100);return d`
        ${h}
        ...
        >
          <div id="track" part="track">
            <div
              id="indicator"
              part="indicator"
              style=${T({"--start":`${U}%`,"--end":`${R}%`})}
            ></div>

            ${p}
            <span id="thumb" part="thumb" style=${T({"--position":`${R}%`})}></span>
          </div>
        ...
        ${M("thumb",this.value)}
      `}}};v.formAssociated=!0;v.observeSlots=!0;v.css=[O,B,ue];o([f("#slider")],v.prototype,"slider",2);o([f("#thumb")],v.prototype,"thumb",2);o([f("#thumb-min")],v.prototype,"thumbMin",2);o([f("#thumb-max")],v.prototype,"thumbMax",2);o([f("#track")],v.prototype,"track",2);o([f("#tooltip")],v.prototype,"tooltip",2);o([s()],v.prototype,"label",2);o([s({attribute:"hint"})],v.prototype,"hint",2);o([s({reflect:!0})],v.prototype,"name",2);o([s({type:Number,attribute:"min-value"})],v.prototype,"minValue",2);o([s({type:Number,attribute:"max-value"})],v.prototype,"maxValue",2);o([s({attribute:"value",reflect:!0,type:Number})],v.prototype,"defaultValue",2);o([x()],v.prototype,"value",1);o([s({type:Boolean,reflect:!0})],v.prototype,"range",2);o([s({type:Boolean})],v.prototype,"disabled",2);o([s({type:Boolean,reflect:!0})],v.prototype,"readonly",2);o([s({reflect:!0})],v.prototype,"orientation",2);o([s({reflect:!0})],v.prototype,"size",2);o([y("size")],v.prototype,"handleSizeChange",1);o([s({attribute:"indicator-offset",type:Number})],v.prototype,"indicatorOffset",2);o([s({type:Number})],v.prototype,"min",2);o([s({type:Number})],v.prototype,"max",2);o([s({type:Number})],v.prototype,"step",2);o([s({type:Boolean})],v.prototype,"autofocus",2);o([s({attribute:"tooltip-distance",type:Number})],v.prototype,"tooltipDistance",2);o([s({attribute:"tooltip-placement",reflect:!0})],v.prototype,"tooltipPlacement",2);o([s({attribute:"with-markers",type:Boolean})],v.prototype,"withMarkers",2);o([s({attribute:"with-tooltip",type:Boolean})],v.prototype,"withTooltip",2);o([s({attribute:"with-label",type:Boolean})],v.prototype,"withLabel",2);o([s({attribute:"with-hint",type:Boolean})],v.prototype,"withHint",2);o([s({attribute:!1})],v.prototype,"valueFormatter",2);v=o([E("wa-slider")],v);/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license *//*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var de=S`
  :host {
    --tag-max-size: 10ch;
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function Ve(t,e){return{top:Math.round(t.getBoundingClientRect().top-e.getBoundingClientRect().top),left:Math.round(t.getBoundingClientRect().left-e.getBoundingClientRect().left)}}function Ft(t,e,i="vertical",r="smooth"){let a=Ve(t,e),n=a.top+e.scrollTop,l=a.left+e.scrollLeft,h=e.scrollLeft,u=e.scrollLeft+e.offsetWidth,p=e.scrollTop,V=e.scrollTop+e.offsetHeight;(i==="horizontal"||i==="both")&&(l<h?e.scrollTo({left:l,behavior:r}):l+t.clientWidth>u&&e.scrollTo({left:l-e.offsetWidth+t.clientWidth,behavior:r})),(i==="vertical"||i==="both")&&(n<p?e.scrollTo({top:n,behavior:r}):n+t.clientHeight>V&&e.scrollTo({top:n-e.offsetHeight+t.clientHeight,behavior:r}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ht=class extends wt{constructor(e){if(super(e),this.it=it,e.type!==vt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===it||e==null)return this._t=void 0,this.it=e;if(e===dt)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;let i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}};ht.directiveName="unsafeHTML",ht.resultType=1;var ce=gt(ht);/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var g=class extends A{constructor(){super(...arguments),this.assumeInteractionOn=["blur","input"],this.cachedOptions=null,this.hasSlotController=new H(this,"hint","label"),this.localize=new z(this),this.selectionOrder=new Map,this.typeToSelectString="",this.slotChangePending=!1,this.displayLabel="",this.selectedOptions=[],this.name="",this._defaultValue=null,this.size="m",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.withClear=!1,this.open=!1,this.appearance="outlined",this.pill=!1,this.label="",this.placement="bottom",this.hint="",this.withLabel=!1,this.withHint=!1,this.required=!1,this.getTag=t=>d`
        <wa-tag
          part="tag"
          exportparts="
            base:tag__base,
      ...
      `,this.handleDocumentFocusIn=t=>{let e=t.composedPath();this&&!e.includes(this)&&this.hide()},this.handleDocumentKeyDown=t=>{let e=t.target,i=e.closest('[part~="clear-button"]')!==null,r=e.closest("wa-button")!==null;if(!(i||r)){if(t.key==="Escape"&&this.open&&rt(this)&&(t.preventDefault(),t.stopPropagation(),this.hide(),this.displayInput.focus({preventScroll:!0})),t.key==="Enter"||t.key===" "&&this.typeToSelectString===""){if(t.preventDefault(),t.stopImmediatePropagation(),!this.open){this.show();return}this.currentOption&&!this.currentOption.disabled&&(this.valueHasChanged=!0,this.hasInteracted=!0,this.multiple?this.toggleOptionSelection(this.currentOption):this.setSelectedOptions(this.currentOption),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.multiple||(this.hide(),this.displayInput.focus({preventScroll:!0})));return}if(["ArrowUp","ArrowDown","Home","End"].includes(t.key)){let a=this.getAllOptions(),n=a.indexOf(this.currentOption),l=Math.max(0,n);if(t.preventDefault(),!this.open&&(this.show(),this.currentOption))return;t.key==="ArrowDown"?(l=n+1,l>a.length-1&&(l=0)):t.key==="ArrowUp"?(l=n-1,l<0&&(l=a.length-1)):t.key==="Home"?l=0:t.key==="End"&&(l=a.length-1),this.setCurrentOption(a[l])}if(t.key?.length===1||t.key==="Backspace"){let a=this.getAllOptions();if(t.metaKey||t.ctrlKey||t.altKey)return;if(!this.open){if(t.key==="Backspace")return;this.show()}t.stopPropagation(),t.preventDefault(),clearTimeout(this.typeToSelectTimeout),this.typeToSelectTimeout=window.setTimeout(()=>this.typeToSelectString="",1e3),t.key==="Backspace"?this.typeToSelectString=this.typeToSelectString.slice(0,-1):this.typeToSelectString+=t.key.toLowerCase();for(let n of a)if(n.label.toLowerCase().startsWith(this.typeToSelectString)){this.setCurrentOption(n);break}}}},this.handleDocumentMouseDown=t=>{let e=t.composedPath();this&&!e.includes(this)&&this.hide()}}static get validators(){let t=[ft({validationElement:Object.assign(document.createElement("select"),{required:!0})})];return[...super.validators,...t]}get validationTarget(){return this.valueInput}set defaultValue(t){this._defaultValue=this.convertDefaultValue(t)}get defaultValue(){return this.convertDefaultValue(this._defaultValue)}rawValuesEqual(t,e){return t==null&&e==null?!0:t==null||e==null||t.length!==e.length?!1:t.every((i,r)=>i===e[r])}convertDefaultValue(t){return!(this.multiple||this.hasAttribute("multiple"))&&Array.isArray(t)&&(t=t[0]),t}set value(t){let e=this.value;t instanceof FormData&&(t=t.getAll(this.name)),t!=null&&!Array.isArray(t)&&(t=[t]);let i=this._value;this._value=t??null,this.rawValuesEqual(i,this._value)||(this.valueHasChanged=!0,this.requestUpdate("value",e))}get value(){let t=this._value??this.defaultValue??null;t!=null&&(t=Array.isArray(t)?t:[t]),this.optionValues=new Set(this.getAllOptions().filter(i=>!i.disabled).map(i=>i.value));let e=t;return t!=null&&(e=t.filter(i=>this.optionValues.has(i)),e=this.multiple?e:e[0],e=e??null),e}handleSizeChange(){L(this.localName,this.size)}connectedCallback(){super.connectedCallback(),this.processSlotChange(),this.open=!1}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.cachedOptions=null}updateDefaultValue(){let e=this.getAllOptions().filter(i=>i.hasAttribute("selected")||i.defaultSelected);if(e.length>0){let i=e.map(r=>r.value);this._defaultValue=this.multiple?i:i[0]}this.hasAttribute("value")&&(this._defaultValue=this.getAttribute("value")||null)}addOpenListeners(){document.addEventListener("focusin",this.handleDocumentFocusIn),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown),pt(this),this.getRootNode()!==document&&this.getRootNode().addEventListener("focusin",this.handleDocumentFocusIn)}removeOpenListeners(){document.removeEventListener("focusin",this.handleDocumentFocusIn),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),mt(this),this.getRootNode()!==document&&this.getRootNode().removeEventListener("focusin",this.handleDocumentFocusIn)}handleFocus(){this.displayInput.setSelectionRange(0,0)}handleLabelClick(){this.displayInput.focus()}handleComboboxClick(t){t.preventDefault()}handleComboboxMouseDown(t){let i=t.composedPath().some(r=>r instanceof Element&&r.tagName.toLowerCase()==="wa-button");this.disabled||i||(t.preventDefault(),this.displayInput.focus({preventScroll:!0}),this.open=!this.open)}handleComboboxKeyDown(t){t.stopPropagation(),this.handleDocumentKeyDown(t)}handleClearClick(t){t.stopPropagation(),this.hasInteracted=!0,this.valueHasChanged=!0,this.value!==null&&(this.displayLabel="",this.selectionOrder.clear(),this.setSelectedOptions([]),this.displayInput.focus({preventScroll:!0}),this.updateComplete.then(()=>{this.dispatchEvent(new Ut),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))}handleClearMouseDown(t){t.stopPropagation(),t.preventDefault()}handleOptionClick(t){let i=t.target.closest("wa-option");i&&!i.disabled&&(this.hasInteracted=!0,this.valueHasChanged=!0,this.multiple?this.toggleOptionSelection(i):this.setSelectedOptions(i),this.updateComplete.then(()=>this.displayInput.focus({preventScroll:!0})),this.requestUpdate("value"),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.multiple||(this.hide(),this.displayInput.focus({preventScroll:!0})))}handleDefaultSlotChange(){this.slotChangePending||(this.slotChangePending=!0,queueMicrotask(()=>{this.slotChangePending=!1,this.processSlotChange()}))}processSlotChange(){if(customElements.get("wa-option")||customElements.whenDefined("wa-option").then(()=>this.handleDefaultSlotChange()),this.didSSR&&!this.hasUpdated){this.updateComplete.then(()=>{this.handleDefaultSlotChange()});return}this.cachedOptions=null;let t=this.getAllOptions();this.updateDefaultValue();let e=this.value;if(e==null||!this.valueHasChanged&&!this.hasInteracted){this.selectionChanged();return}Array.isArray(e)||(e=[e]);let i=t.filter(r=>e.includes(r.value));this.setSelectedOptions(i)}handleTagRemove(t,e){if(t.stopPropagation(),this.disabled)return;this.hasInteracted=!0,this.valueHasChanged=!0;let i=e;if(!i){let r=t.target.closest("wa-tag[data-value]");if(r){let a=r.dataset.value;i=this.selectedOptions.find(n=>n.value===a)}}i&&(this.toggleOptionSelection(i,!1),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}))}getAllOptions(){return this.cachedOptions?this.cachedOptions:this?.querySelectorAll?(this.cachedOptions=[...this.querySelectorAll("wa-option")],this.cachedOptions):[]}getFirstOption(){return this.querySelector("wa-option")}setCurrentOption(t){this.getAllOptions().forEach(i=>{i.current=!1,i.tabIndex=-1}),t&&(this.currentOption=t,t.current=!0,t.tabIndex=0,t.focus({preventScroll:!0}),this.open&&!this.listbox.hidden&&Ft(t,this.listbox,"vertical","auto"))}setSelectedOptions(t){let e=this.getAllOptions(),i=Array.isArray(t)?t:[t];e.forEach(r=>{i.includes(r)||(r.selected=!1)}),i.length&&i.forEach(r=>r.selected=!0),this.selectionChanged()}toggleOptionSelection(t,e){e===!0||e===!1?t.selected=e:t.selected=!t.selected,this.selectionChanged()}selectionChanged(){let e=this.getAllOptions().filter(l=>{if(!this.hasInteracted&&!this.valueHasChanged){let h=this.defaultValue,u=Array.isArray(h)?h:[h];return l.hasAttribute("selected")||l.defaultSelected||l.selected||u?.includes(l.value)}return l.selected}),i=new Set(e.map(l=>l.value));for(let l of this.selectionOrder.keys())i.has(l)||this.selectionOrder.delete(l);let a=(this.selectionOrder.size>0?Math.max(...this.selectionOrder.values()):-1)+1;for(let l of e)this.selectionOrder.has(l.value)||this.selectionOrder.set(l.value,a++);this.selectedOptions=e.sort((l,h)=>{let u=this.selectionOrder.get(l.value)??0,p=this.selectionOrder.get(h.value)??0;return u-p});let n=new Set(this.selectedOptions.map(l=>l.value));if(n.size>0||this._value){let l=this._value;if(this._value==null){let h=this.defaultValue??[];this._value=Array.isArray(h)?h:[h]}this._value=this._value?.filter(h=>!this.optionValues?.has(h))??null,this._value?.unshift(...n),this.requestUpdate("value",l)}if(this.multiple)this.placeholder&&!this.value?.length?this.displayLabel="":this.displayLabel=this.localize.term("numOptionsSelected",this.selectedOptions.length);else{let l=this.selectedOptions[0];this.displayLabel=l?.label??""}this.updateComplete.then(()=>{this.updateValidity()})}get tags(){return this.selectedOptions.map((t,e)=>{if(e<this.maxOptionsVisible||this.maxOptionsVisible<=0){let i=this.getTag(t,e);return i?typeof i=="string"?ce(i):i:null}else if(e===this.maxOptionsVisible)return d`
          ...
          >
        `;return null})}updated(t){super.updated(t),(t.has("value")||t.has("displayLabel"))&&this.customStates.set("blank",!this.value&&!this.displayLabel)}handleDisabledChange(){this.disabled&&this.open&&(this.open=!1)}handleValueChange(){let t=this.getAllOptions(),e=Array.isArray(this.value)?this.value:[this.value],i=t.filter(r=>e.includes(r.value));this.setSelectedOptions(i),this.updateValidity()}async handleOpenChange(){if(this.open&&!this.disabled){this.setCurrentOption(this.selectedOptions[0]||this.getFirstOption());let t=new Wt;if(this.dispatchEvent(t),t.defaultPrevented){this.open=!1;return}this.addOpenListeners(),this.listbox.hidden=!1,this.popup.active=!0,requestAnimationFrame(()=>{this.setCurrentOption(this.currentOption)}),await Q(this.popup.popup,"show"),this.currentOption&&Ft(this.currentOption,this.listbox,"vertical","auto"),this.dispatchEvent(new jt)}else{let t=new Pt;if(this.dispatchEvent(t),t.defaultPrevented){this.open=!1;return}this.removeOpenListeners(),await Q(this.popup.popup,"hide"),this.listbox.hidden=!0,this.popup.active=!1,this.dispatchEvent(new Kt)}}async show(){if(this.open||this.disabled){this.open=!1;return}return this.open=!0,J(this,"wa-after-show")}async hide(){if(!this.open||this.disabled){this.open=!1;return}return this.open=!1,J(this,"wa-after-hide")}focus(t){this.displayInput.focus(t)}blur(){this.displayInput.blur()}formResetCallback(){this.selectionOrder.clear(),this.value=this.defaultValue,super.formResetCallback(),this.handleValueChange(),this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}render(){let t=this.hasSlotController.test("label","withLabel"),e=this.hasSlotController.test("hint","withHint"),i=this.label?!0:!!t,r=this.hint?!0:!!e,a=(this.hasUpdated||!1)&&this.withClear&&!this.disabled&&(this.displayLabel||this.value&&this.value.length>0);return d`
      <div
        part="form-control"
        class=${C({"form-control":!0,"form-control-has-label":i})}
      >
        <label
          id="label"
          part="form-control-label label"
          class=${C({label:!0,"has-label":i})}
    ...
    `}};g.css=[de,B,O];o([f(".select")],g.prototype,"popup",2);o([f(".combobox")],g.prototype,"combobox",2);o([f(".display-input")],g.prototype,"displayInput",2);o([f(".value-input")],g.prototype,"valueInput",2);o([f(".listbox")],g.prototype,"listbox",2);o([x()],g.prototype,"displayLabel",2);o([x()],g.prototype,"currentOption",2);o([x()],g.prototype,"selectedOptions",2);o([s({reflect:!0})],g.prototype,"name",2);o([s({attribute:!1})],g.prototype,"defaultValue",1);o([s({attribute:"value",reflect:!1})],g.prototype,"value",1);o([s({reflect:!0})],g.prototype,"size",2);o([y("size")],g.prototype,"handleSizeChange",1);o([s()],g.prototype,"placeholder",2);o([s({type:Boolean,reflect:!0})],g.prototype,"multiple",2);o([s({attribute:"max-options-visible",type:Number})],g.prototype,"maxOptionsVisible",2);o([s({type:Boolean})],g.prototype,"disabled",2);o([s({attribute:"with-clear",type:Boolean})],g.prototype,"withClear",2);o([s({type:Boolean,reflect:!0})],g.prototype,"open",2);o([s({reflect:!0})],g.prototype,"appearance",2);o([s({type:Boolean,reflect:!0})],g.prototype,"pill",2);o([s()],g.prototype,"label",2);o([s({reflect:!0})],g.prototype,"placement",2);o([s({attribute:"hint"})],g.prototype,"hint",2);o([s({attribute:"with-label",type:Boolean})],g.prototype,"withLabel",2);o([s({attribute:"with-hint",type:Boolean})],g.prototype,"withHint",2);o([s({type:Boolean,reflect:!0})],g.prototype,"required",2);o([s({attribute:!1})],g.prototype,"getTag",2);o([y("disabled",{waitUntilFirstUpdate:!0})],g.prototype,"handleDisabledChange",1);o([y("value",{waitUntilFirstUpdate:!0})],g.prototype,"handleValueChange",1);o([y("open",{waitUntilFirstUpdate:!0})],g.prototype,"handleOpenChange",1);g=o([E("wa-select")],g);g.disableWarning?.("change-in-update");/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var pe=class extends Event{constructor(){super("wa-remove",{bubbles:!0,cancelable:!1,composed:!0})}};/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var me=S`
  @layer wa-component {
    :host {
      display: inline-flex;
      gap: 0.5em;
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var K=class extends W{constructor(){super(...arguments),this.localize=new z(this),this.variant="neutral",this.appearance="filled-outlined",this.size="m",this.pill=!1,this.withRemove=!1}handleSizeChange(){L(this.localName,this.size)}handleRemoveClick(){this.dispatchEvent(new pe)}render(){return d`
      ...
      ${this.withRemove?d`
          ...
          `:""}
    `}};K.css=[me,Ct,O];o([s({reflect:!0})],K.prototype,"variant",2);o([s({reflect:!0})],K.prototype,"appearance",2);o([s({reflect:!0})],K.prototype,"size",2);o([y("size")],K.prototype,"handleSizeChange",1);o([s({type:Boolean,reflect:!0})],K.prototype,"pill",2);o([s({attribute:"with-remove",type:Boolean})],K.prototype,"withRemove",2);K=o([E("wa-tag")],K);/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var fe=S`
  :host {
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */function ut(t,e=0){if(!t||!globalThis.Node)return"";if(typeof t[Symbol.iterator]=="function")return(Array.isArray(t)?t:[...t]).map(a=>ut(a,--e)).join("");let i=t;if(i.nodeType===Node.TEXT_NODE)return i.textContent??"";if(i.nodeType===Node.ELEMENT_NODE){let r=i;if(r.hasAttribute("slot")||r.matches("style, script"))return"";if(r instanceof HTMLSlotElement){let a=r.assignedNodes({flatten:!0});if(a.length>0)return ut(a,--e)}return e>-1?ut(r,--e):r.textContent??""}return i.hasChildNodes()?ut(i.childNodes,--e):""}var N=class extends W{constructor(){super(...arguments),this.localize=new z(this),this.cachedDefaultLabel="",this.isInitialized=!1,this.isDefaultLabelDirty=!0,this.current=!1,this.value="",this.disabled=!1,this.selected=!1,this.defaultSelected=!1,this._label="",this.handleHover=t=>{t.type==="mouseenter"?this.customStates.set("hover",!0):t.type==="mouseleave"&&this.customStates.set("hover",!1)}}set label(t){let e=this._label;this._label=t||"",this._label!==e&&this.requestUpdate("label",e)}get label(){return this._label?this._label:this.defaultLabel}get defaultLabel(){return(this.isDefaultLabelDirty||!this.cachedDefaultLabel)&&this.updateDefaultLabel(),this.cachedDefaultLabel}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false"),this.addEventListener("mouseenter",this.handleHover),this.addEventListener("mouseleave",this.handleHover)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("mouseenter",this.handleHover),this.removeEventListener("mouseleave",this.handleHover)}handleDefaultSlotChange(){this.isDefaultLabelDirty=!0,this.isInitialized?(customElements.whenDefined("wa-select").then(()=>{let t=this.closest("wa-select");t&&t.handleDefaultSlotChange?.()}),customElements.whenDefined("wa-combobox").then(()=>{let t=this.closest("wa-combobox");t&&t.handleDefaultSlotChange?.()})):this.isInitialized=!0}willUpdate(t){t.has("defaultSelected")&&(this.didSSR&&this.hasUpdated||!this.didSSR)&&this.syncDefaultSelected(),super.willUpdate(t)}syncDefaultSelected(){if("closest"in this&&!this.closest("wa-combobox, wa-select")?.hasInteracted&&this.defaultSelected){let t=this.selected;this.selected=this.defaultSelected,this.requestUpdate("selected",t)}}updated(t){t.has("disabled")&&(this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.customStates.set("disabled",this.disabled)),t.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.customStates.set("selected",this.selected)),t.has("value")&&(typeof this.value!="string"&&(this.value=String(this.value)),this.handleDefaultSlotChange()),t.has("current")&&this.customStates.set("current",this.current),super.updated(t)}async firstUpdated(t){if(super.firstUpdated(t),this.didSSR&&!this.hasUpdated?(await this.updateComplete,this.syncDefaultSelected()):this.syncDefaultSelected(),this.selected&&!this.defaultSelected){let e=this.closest("wa-select, wa-combobox");e&&!e.hasInteracted&&(await customElements.whenDefined(e?.localName),await e.updateComplete,e.selectionChanged?.())}}updateDefaultLabel(){let t=this.cachedDefaultLabel;this.cachedDefaultLabel=ut(this).trim(),this.isDefaultLabelDirty=!1;let e=this.cachedDefaultLabel!==t;return!this._label&&e&&this.requestUpdate("label",t),e}render(){let t=this.selected;return this.didSSR&&!this.hasUpdated?(this.updateComplete.then(()=>{this.requestUpdate()}),it):d`
    ...
    `}};N.css=fe;o([f(".label")],N.prototype,"defaultSlot",2);o([x()],N.prototype,"current",2);o([s({reflect:!0})],N.prototype,"value",2);o([s({type:Boolean})],N.prototype,"disabled",2);o([s({type:Boolean,attribute:!1})],N.prototype,"selected",2);o([s({type:Boolean,attribute:"selected"})],N.prototype,"defaultSelected",2);o([s()],N.prototype,"label",1);N=o([E("wa-option")],N);/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license *//*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license *//*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var be=S`
  :host {
    border-width: 0;
  }
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var b=class extends A{constructor(){super(...arguments),this.assumeInteractionOn=["blur","input"],this.hasSlotController=new H(this,"hint","label"),this.localize=new z(this),this.announcedCountText="",this.title="",this.name=null,this._value=null,this.defaultValue=this.getAttribute("value")??"",this.size="m",this.appearance="outlined",this.label="",this.hint="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.required=!1,this.spellcheck=!0,this.withLabel=!1,this.withHint=!1,this.withCount=!1,this.lastObservedWidth=0}static get validators(){return[...super.validators,j()]}get value(){return this.valueHasChanged?this._value:this._value??this.defaultValue}set value(t){this._value!==t&&(this.valueHasChanged=!0,this._value=t)}handleSizeChange(){L(this.localName,this.size)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{if(this.setTextareaDimensions(),this.updateResizeObserver(),this.didSSR&&this.input&&this.value!==this.input.value){let t=this.input.value;this.value=t}})}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.countAnnounceTimeout),this.resizeObserver?.disconnect(),this.resizeObserver=void 0}updateFormValue(t){if(t==null){this.setValue("",null);return}super.updateFormValue(t)}updateResizeObserver(){let t=this.resize!=="none";this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=void 0),t&&this.input&&(this.resize==="auto"?(this.resizeObserver=new ResizeObserver(e=>{let i=e[0]?.contentRect.width??0;i!==this.lastObservedWidth&&(this.lastObservedWidth=i,requestAnimationFrame(()=>this.setTextareaDimensions()))}),this.resizeObserver.observe(this)):(this.resizeObserver=new ResizeObserver(()=>this.setTextareaDimensions()),this.resizeObserver.observe(this.input)))}handleBlur(){this.checkValidity()}handleChange(t){this.valueHasChanged=!0,this.value=this.input.value,this.setTextareaDimensions(),this.checkValidity(),this.relayNativeEvent(t,{bubbles:!0,composed:!0})}handleInput(t){this.valueHasChanged=!0,this.value=this.input.value,this.relayNativeEvent(t,{bubbles:!0,composed:!0}),this.scheduleCountAnnouncement()}scheduleCountAnnouncement(){clearTimeout(this.countAnnounceTimeout),this.countAnnounceTimeout=setTimeout(()=>{let t=(this.value??"").length;this.announcedCountText=this.maxlength!=null?this.localize.term("numCharactersRemaining",this.maxlength-t):this.localize.term("numCharacters",t)},1e3)}setTextareaDimensions(){if(this.resize==="none"){this.base.style.width="",this.base.style.height="";return}if(this.resize==="auto"){this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto";let t=this.input.scrollHeight;this.input.style.height=`${t}px`,this.sizeAdjuster.style.height=`${t}px`,this.base.style.width="",this.base.style.height="";return}if(this.input.style.width){let t=Number(this.input.style.width.split(/px/)[0])+2;this.base.style.width=`${t}px`}if(this.input.style.height){let t=Number(this.input.style.height.split(/px/)[0])+2;this.base.style.height=`${t}px`}}handleRowsChange(){this.setTextareaDimensions()}async handleValueChange(){await this.updateComplete,this.checkValidity(),this.setTextareaDimensions()}updated(t){t.has("resize")&&(this.setTextareaDimensions(),this.updateResizeObserver()),super.updated(t),t.has("value")&&this.customStates.set("blank",!this.value)}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(t){if(t){typeof t.top=="number"&&(this.input.scrollTop=t.top),typeof t.left=="number"&&(this.input.scrollLeft=t.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(t,e,i="none"){this.input.setSelectionRange(t,e,i)}setRangeText(t,e,i,r="preserve"){let a=e??this.input.selectionStart,n=i??this.input.selectionEnd;this.input.setRangeText(t,a,n,r),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaDimensions())}formResetCallback(){this._value=null,this.input&&(this.input.value=this.value||""),super.formResetCallback()}render(){let t=this.hasSlotController.test("label","withLabel"),e=this.hasSlotController.test("hint","withHint"),i=this.label?!0:!!t,r=this.hint?!0:!!e,a=(this.value??"").length,n=this.maxlength!=null?this.localize.term("numCharactersRemaining",this.maxlength-a):this.localize.term("numCharacters",a);return d`
      ...
      <div
        part="hint"
        class=${C({footer:!0,"has-count":this.withCount,"has-slotted":r})}
      >
    ...
    `}};b.css=[be,B,O,ct];o([x()],b.prototype,"announcedCountText",2);o([f(".control")],b.prototype,"input",2);o([f('[part~="base"]')],b.prototype,"base",2);o([f(".size-adjuster")],b.prototype,"sizeAdjuster",2);o([s()],b.prototype,"title",2);o([s({reflect:!0})],b.prototype,"name",2);o([x()],b.prototype,"value",1);o([s({attribute:"value",reflect:!0})],b.prototype,"defaultValue",2);o([s({reflect:!0})],b.prototype,"size",2);o([y("size")],b.prototype,"handleSizeChange",1);o([s({reflect:!0})],b.prototype,"appearance",2);o([s()],b.prototype,"label",2);o([s({attribute:"hint"})],b.prototype,"hint",2);o([s()],b.prototype,"placeholder",2);o([s({type:Number})],b.prototype,"rows",2);o([s({reflect:!0})],b.prototype,"resize",2);o([s({type:Boolean})],b.prototype,"disabled",2);o([s({type:Boolean,reflect:!0})],b.prototype,"readonly",2);o([s({type:Boolean,reflect:!0})],b.prototype,"required",2);o([s({type:Number})],b.prototype,"minlength",2);o([s({type:Number})],b.prototype,"maxlength",2);o([s()],b.prototype,"autocapitalize",2);o([s({type:Boolean,converter:{fromAttribute:t=>!(!t||t==="off"),toAttribute:t=>t?"on":"off"}})],b.prototype,"autocorrect",2);o([s()],b.prototype,"autocomplete",2);o([s({type:Boolean})],b.prototype,"autofocus",2);o([s()],b.prototype,"enterkeyhint",2);o([s({type:Boolean,converter:{fromAttribute:t=>!(!t||t==="false"),toAttribute:t=>t?"true":"false"}})],b.prototype,"spellcheck",2);o([s()],b.prototype,"inputmode",2);o([s({attribute:"with-label",type:Boolean})],b.prototype,"withLabel",2);o([s({attribute:"with-hint",type:Boolean})],b.prototype,"withHint",2);o([s({attribute:"with-count",type:Boolean,reflect:!0})],b.prototype,"withCount",2);o([y("rows",{waitUntilFirstUpdate:!0})],b.prototype,"handleRowsChange",1);o([y("value",{waitUntilFirstUpdate:!0})],b.prototype,"handleValueChange",1);b=o([E("wa-textarea")],b);b.disableWarning?.("change-in-update");/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license *//*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var ve=S`
  :host(:focus) {
    outline: none;
  }
...
`;/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */var k=class extends A{constructor(){super(...arguments),this.assumeInteractionOn=["blur","input"],this.hasSlotController=new H(this,"hint","label"),this.localize=new z(this),this.title="",this._value=null,this.defaultValue=this.getAttribute("value")||null,this.size="m",this.appearance="outlined",this.pill=!1,this.label="",this.hint="",this.placeholder="",this.readonly=!1,this.required=!1,this.step=1,this.withoutSteppers=!1,this.inputmode="numeric",this.withLabel=!1,this.withHint=!1}static get validators(){return[...super.validators,j()]}get value(){return this.valueHasChanged?this._value:this._value??this.defaultValue}set value(t){this._value!==t&&(this.valueHasChanged=!0,this._value=t)}handleSizeChange(){L(this.localName,this.size)}updateFormValue(t){if(t==null){this.setValue("",null);return}super.updateFormValue(t)}get isAtMin(){if(this.min===void 0)return!1;let t=parseFloat(this.value||"");return!isNaN(t)&&t<=this.min}get isAtMax(){if(this.max===void 0)return!1;let t=parseFloat(this.value||"");return!isNaN(t)&&t>=this.max}handleChange(t){this.value=this.input.value,this.relayNativeEvent(t,{bubbles:!0,composed:!0})}handleInput(){this.value=this.input.value}handleKeyDown(t){yt(t,this),(t.key==="ArrowUp"||t.key==="ArrowDown")&&requestAnimationFrame(()=>{this.value!==this.input.value&&(this.value=this.input.value)})}handleStepperPointerUp(t,e){if(this.disabled||this.readonly)return;let i=new InputEvent("beforeinput",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(i),!i.defaultPrevented&&(t==="up"?this.input.stepUp():this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),e.pointerType!=="touch"&&this.input.focus())}handleStepperPointerDown(t){t.pointerType!=="touch"&&(t.preventDefault(),this.input.focus())}updated(t){super.updated(t),(t.has("value")||t.has("defaultValue"))&&(this.input&&this.value&&this.input.value!==this.value&&(this._value=this.input.value),this.customStates.set("blank",!this.value))}handleStepChange(){this.input.step=String(this.step),this.updateValidity()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}formResetCallback(){this.value=this.defaultValue,super.formResetCallback()}render(){let t=this.hasSlotController.test("label","withLabel"),e=this.hasSlotController.test("hint","withHint"),i=this.label?!0:!!t,r=this.hint?!0:!!e;return d`
      ...
      <slot
        ...
        >${this.hint}</slot
      >
    `}};k.css=[O,B,ve];k.shadowRootOptions={...A.shadowRootOptions,delegatesFocus:!0};o([f("input")],k.prototype,"input",2);o([s()],k.prototype,"title",2);o([x()],k.prototype,"value",1);o([s({attribute:"value",reflect:!0})],k.prototype,"defaultValue",2);o([s({reflect:!0})],k.prototype,"size",2);o([y("size")],k.prototype,"handleSizeChange",1);o([s({reflect:!0})],k.prototype,"appearance",2);o([s({type:Boolean,reflect:!0})],k.prototype,"pill",2);o([s()],k.prototype,"label",2);o([s({attribute:"hint"})],k.prototype,"hint",2);o([s()],k.prototype,"placeholder",2);o([s({type:Boolean,reflect:!0})],k.prototype,"readonly",2);o([s({type:Boolean,reflect:!0})],k.prototype,"required",2);o([s({type:Number})],k.prototype,"min",2);o([s({type:Number})],k.prototype,"max",2);o([s()],k.prototype,"step",2);o([s({attribute:"without-steppers",type:Boolean})],k.prototype,"withoutSteppers",2);o([s()],k.prototype,"autocomplete",2);o([s({type:Boolean})],k.prototype,"autofocus",2);o([s()],k.prototype,"enterkeyhint",2);o([s()],k.prototype,"inputmode",2);o([s({attribute:"with-label",type:Boolean})],k.prototype,"withLabel",2);o([s({attribute:"with-hint",type:Boolean})],k.prototype,"withHint",2);o([y("step",{waitUntilFirstUpdate:!0})],k.prototype,"handleStepChange",1);k=o([E("wa-number-input")],k);k.disableWarning?.("change-in-update");/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */
