...
/* Anchor resolution, painting, and anchor-specific travel.
   ...
   in. The card paints a quiet ground; `:focus-visible` instead answers which input
   modality should draw a strong focus indicator. While typing, the reply box carries
   that ring and the enclosing thread keeps its subdued surface.
