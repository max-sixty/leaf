...
A worker's report reaches you as a delivered event, whose `handling` says how a
stamped version answers it.
...
processes its report, updates the source that adjudicates it, and stamps the
checkpoint when it is meaningful.
