...
results="$repo/notes/mcp-apps/experiments/16/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-16.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/16/observe.py "$run_dir/page" \
