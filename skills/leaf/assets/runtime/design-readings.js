 ...
 *
 * Command owners receive the live mode query from createDesignController. These
...
import { itemWord } from "./anchor-resolution.js";
...
export function designName(element) {
  ...
  return `${tag.startsWith("lf-") ? tag : itemWord(element)} · ${element.id}`;
}
