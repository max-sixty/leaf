...
PageStateService and event admission. The probe uses the Ship Review page.
...
reference host. It also verified accepted ui/message transport, not Codex idle wake. This is a
