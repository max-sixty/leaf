...
// chip right once per enclosing box. If that position crosses the shortcut-bar band and the
...
export const SELECT = {
  ...
  // keyboard projection. If character key shortcuts are off, the row binds nothing and
