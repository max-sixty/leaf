#!/usr/bin/env python3
"""Write the x- key table in docs/customizing.html from the registry's $keys.
...
Usage: keydocs.py  (no arguments; rewrites docs/customizing.html in place)
"""
...
DOCS_PAGE = ROOT / "docs" / "customizing.html"
