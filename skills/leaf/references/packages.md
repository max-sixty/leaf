...
ordered website run, aligned before-and-after evidence, automatic compare orientation,
local flip and overlay, fit and captured-size inspection, exact preview links, and case dispositions.
`gallery`
