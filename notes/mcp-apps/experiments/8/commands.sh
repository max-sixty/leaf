...
results="$repo/notes/mcp-apps/experiments/8/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-8.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/8/observe.py "$run_dir/page" \
