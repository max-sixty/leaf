...
results="$repo/notes/mcp-apps/experiments/17/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-17.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/17/observe.py "$run_dir/page" \
