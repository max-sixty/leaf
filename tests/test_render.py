...
def test_a_key_walks_the_page_s_open_asks(browser, serve):
    ...
    walks — vim's list, less's half page, the brackets that step versions, next and
    previous — which is what leaves `a` to the answer that takes all of them at once.
