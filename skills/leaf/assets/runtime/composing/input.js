...
// surface (an impatient second click), and submit with Enter. Shift+Enter retains the
// textarea's native newline. Mod+Enter remains another route to submit. The stylesheet owns
