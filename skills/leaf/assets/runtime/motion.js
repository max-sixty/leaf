...
// state. Every motion the product makes comes through here, so they share one ease and
// one held-end-frame contract. A duration a caller passes in is still a number this
// module has no reason for; see CLAUDE.md's "Motion".
