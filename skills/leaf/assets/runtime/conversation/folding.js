...
/* Resolve and Reopen, in the panel and inline.
   ...
   Panel and inline settlement controls read pending work from the outbox. The local
...
// Its place is not given up in the frame the projection settles it: the node stays where it stood, says what
