...
vendored layer plus each example, materializes the version responses Leaf's server
normally supplies at virtual routes, rewrites checkout-relative assets, and refuses
