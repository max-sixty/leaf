...
results="$repo/notes/mcp-apps/experiments/14/results"
run_dir="$(mktemp -d "$repo/.tmp/mcp-app-experiment-14.XXXXXX")"
...
uv run python notes/mcp-apps/experiments/14/observe.py "$run_dir/page" \
